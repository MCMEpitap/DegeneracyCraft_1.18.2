...
import net.epitap.degeneracycraft.blocks.machine.basic.dynamic_energetics.basic_power_steam_generator.BasicPowerSteamGeneratorBlock;
import net.epitap.degeneracycraft.blocks.machine.basic.dynamic_energetics.basic_technology_compression_condenser.BasicTechnologyCompressionCondenserBlock;
import net.epitap.degeneracycraft.blocks.machine.basic.dynamic_energetics.basic_technology_electromagnetic_inductor.BasicTechnologyElectromagneticInductorBlock;
...
import net.epitap.degeneracycraft.blocks.machine.basic.jenith_void_science.basic_technology_void_world_coordinate_recording_machine.BasicTechnologyVoidWorldCoordinateRecordingMachineBlock;
import net.epitap.degeneracycraft.blocks.machine.basic.kaleidoscopic_reality_science.basic_performance_reality_phase_adjustment_machine.BasicPerformanceRealityPhaseAdjustmentMachineBlock;
...
import net.epitap.degeneracycraft.blocks.storage.basic.astronomy.bus.basic_strength_astronomy_multiblock_energy_output_bus.BasicStrengthAstronomyMultiblockEnergyOutputBusBlock;
...
import net.epitap.degeneracycraft.blocks.storage.basic.astronomy.item_storage.basic_strength_astronomy_multiblock_item_storage.BasicStrengthAstronomyMultiblockItemStorageBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.astronomy.port.basic_strength_astronomy_multiblock_item_input_port.BasicStrengthAstronomyMultiblockItemInputPortBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.astronomy.port.basic_strength_astronomy_multiblock_item_output_port.BasicStrengthAstronomyMultiblockItemOutputPortBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.biology.bus.basic_strength_biology_multiblock_energy_input_bus.BasicStrengthBiologyMultiblockEnergyInputBusBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.biology.bus.basic_strength_biology_multiblock_energy_output_bus.BasicStrengthBiologyMultiblockEnergyOutputBusBlock;
...
import net.epitap.degeneracycraft.blocks.storage.basic.biology.item_storage.basic_strength_biology_multiblock_item_storage.BasicStrengthBiologyMultiblockItemStorageBlock;
...
import net.epitap.degeneracycraft.blocks.storage.basic.engineering.bus.basic_strength_engineering_multiblock_energy_input_bus.BasicStrengthEngineeringMultiblockEnergyInputBusBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.engineering.bus.basic_strength_engineering_multiblock_energy_output_bus.BasicStrengthEngineeringMultiblockEnergyOutputBusBlock;
...
import net.epitap.degeneracycraft.blocks.storage.basic.engineering.port.basic_strength_engineering_multiblock_item_input_port.BasicStrengthEngineeringMultiblockItemInputPortBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.engineering.port.basic_strength_engineering_multiblock_item_output_port.BasicStrengthEngineeringMultiblockItemOutputPortBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.formal_science.bus.basic_strength_formal_science_multiblock_energy_input_bus.BasicStrengthFormalScienceMultiblockEnergyInputBusBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.formal_science.bus.basic_strength_formal_science_multiblock_energy_output_bus.BasicStrengthFormalScienceMultiblockEnergyOutputBusBlock;
...
import net.epitap.degeneracycraft.blocks.storage.basic.formal_science.item_storage.basic_strength_formal_science_multiblock_item_storage.BasicStrengthFormalScienceMultiblockItemStorageBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.formal_science.port.basic_strength_formal_science_multiblock_item_input_port.BasicStrengthFormalScienceMultiblockItemInputPortBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.formal_science.port.basic_strength_formal_science_multiblock_item_output_port.BasicStrengthFormalScienceMultiblockItemOutputPortBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.geo_science.bus.basic_strength_geo_science_multiblock_energy_input_bus.BasicStrengthGeoScienceMultiblockEnergyInputBusBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.geo_science.bus.basic_strength_geo_science_multiblock_energy_output_bus.BasicStrengthGeoScienceMultiblockEnergyOutputBusBlock;
...
import net.epitap.degeneracycraft.blocks.storage.basic.imitation_magic_engineering.bus.basic_strength_imitation_magic_engineering_multiblock_energy_input_bus.BasicStrengthImitationMagicEngineeringMultiblockEnergyInputBusBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.imitation_magic_engineering.bus.basic_strength_imitation_magic_engineering_multiblock_energy_output_bus.BasicStrengthImitationMagicEngineeringMultiblockEnergyOutputBusBlock;
...
import net.epitap.degeneracycraft.blocks.storage.basic.imitation_magic_engineering.port.basic_strength_imitation_magic_engineering_multiblock_item_input_port.BasicStrengthImitationMagicEngineeringMultiblockItemInputPortBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.imitation_magic_engineering.port.basic_strength_imitation_magic_engineering_multiblock_item_output_port.BasicStrengthImitationMagicEngineeringMultiblockItemOutputPortBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.jenith_void_science.bus.basic_strength_jenith_void_science_multiblock_energy_input_bus.BasicStrengthJenithVoidScienceMultiblockEnergyInputBusBlock;
import net.epitap.degeneracycraft.blocks.storage.basic.jenith_void_science.bus.basic_strength_jenith_void_science_multiblock_energy_output_bus.BasicStrengthJenithVoidScienceMultiblockEnergyOutputBusBlock;
...
import net.epitap.degeneracycraft.transport.bus_port.basic.dynamic_energetics.basic_power_steam_generator.bus.BasicPowerSteamGeneratorBusBlock;
import net.epitap.degeneracycraft.transport.bus_port.basic.dynamic_energetics.basic_power_steam_generator.port.BasicPowerSteamGeneratorPortBlock;
import net.epitap.degeneracycraft.transport.bus_port.basic.dynamic_energetics.basic_technology_compression_condenser.bus.BasicTechnologyCompressionCondenserBusBlock;
import net.epitap.degeneracycraft.transport.bus_port.basic.dynamic_energetics.basic_technology_compression_condenser.port.BasicTechnologyCompressionCondenserPortBlock;
import net.epitap.degeneracycraft.transport.bus_port.basic.dynamic_energetics.basic_technology_electromagnetic_inductor.bus.BasicTechnologyElectromagneticInductorBusBlock;
import net.epitap.degeneracycraft.transport.bus_port.basic.dynamic_energetics.basic_technology_electromagnetic_inductor.port.BasicTechnologyElectromagneticInductorPortBlock;
...
import net.epitap.degeneracycraft.transport.bus_port.basic.formal_science.basic_performance_circuit_builder.bus.BasicPerformanceCircuitBuilderBusBlock;
import net.epitap.degeneracycraft.transport.bus_port.basic.formal_science.basic_performance_circuit_builder.port.BasicPerformanceCircuitBuilderPortBlock;
import net.epitap.degeneracycraft.transport.bus_port.basic.formal_science.basic_performance_designated_data_injector.bus.BasicPerformanceDesignatedDataInjectorBusBlock;
...
import net.epitap.degeneracycraft.transport.bus_port.basic.imitation_magic_engineering.basic_technology_virtual_sigil_processor.bus.BasicTechnologyVirtualSigilProcessorBusBlock;
import net.epitap.degeneracycraft.transport.bus_port.basic.imitation_magic_engineering.basic_technology_virtual_sigil_processor.port.BasicTechnologyVirtualSigilProcessorPortBlock;
import net.epitap.degeneracycraft.transport.bus_port.basic.jenith_void_science.basic_technology_void_world_coordinate_recording_machine.bus.BasicTechnologyVoidWorldCoordinateRecordingMachineBusBlock;
import net.epitap.degeneracycraft.transport.bus_port.basic.jenith_void_science.basic_technology_void_world_coordinate_recording_machine.port.BasicTechnologyVoidWorldCoordinateRecordingMachinePortBlock;
import net.epitap.degeneracycraft.transport.bus_port.basic.kaleidoscopic_reality_science.basic_performance_reality_phase_adjustment_machine.bus.BasicPerformanceRealityPhaseAdjustmentMachineBusBlock;
import net.epitap.degeneracycraft.transport.bus_port.basic.kaleidoscopic_reality_science.basic_performance_reality_phase_adjustment_machine.port.BasicPerformanceRealityPhaseAdjustmentMachinePortBlock;
...
public class DCBlocks {
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_ASTRONOMY_MULTIBLOCK_ITEM_STORAGE_BLOCK = registerBlock("basic_strength_astronomy_multiblock_item_storage_block", () ->
            new BasicStrengthAstronomyMultiblockItemStorageBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_ASTRONOMY_MULTIBLOCK_ENERGY_INPUT_BUS_BLOCK = registerBlock("basic_strength_astronomy_multiblock_energy_input_bus_block", () ->
            new BasicStrengthAstronomyMultiblockEnergyInputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_ASTRONOMY_MULTIBLOCK_ENERGY_OUTPUT_BUS_BLOCK = registerBlock("basic_strength_astronomy_multiblock_energy_output_bus_block", () ->
            new BasicStrengthAstronomyMultiblockEnergyOutputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_ASTRONOMY_MULTIBLOCK_ITEM_INPUT_PORT_BLOCK = registerBlock("basic_strength_astronomy_multiblock_item_input_port_block", () ->
            new BasicStrengthAstronomyMultiblockItemInputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_ASTRONOMY_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK = registerBlock("basic_strength_astronomy_multiblock_item_output_port_block", () ->
            new BasicStrengthAstronomyMultiblockItemOutputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_ITEM_STORAGE_BLOCK = registerBlock("basic_strength_biology_multiblock_item_storage_block", () ->
            new BasicStrengthBiologyMultiblockItemStorageBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_ENERGY_INPUT_BUS_BLOCK = registerBlock("basic_strength_biology_multiblock_energy_input_bus_block", () ->
            new BasicStrengthBiologyMultiblockEnergyInputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_ENERGY_OUTPUT_BUS_BLOCK = registerBlock("basic_strength_biology_multiblock_energy_output_bus_block", () ->
            new BasicStrengthBiologyMultiblockEnergyOutputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_ITEM_INPUT_PORT_BLOCK = registerBlock("basic_strength_biology_multiblock_item_input_port_block", () ->
            new BasicStrengthBiologyMultiblockItemInputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK = registerBlock("basic_strength_biology_multiblock_item_output_port_block", () ->
            new BasicStrengthBiologyMultiblockItemOutputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_CHEMISTRY_MULTIBLOCK_ITEM_STORAGE_BLOCK = registerBlock("basic_strength_chemistry_multiblock_item_storage_block", () ->
            new BasicStrengthChemistryMultiblockItemStorageBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_CHEMISTRY_MULTIBLOCK_ENERGY_INPUT_BUS_BLOCK = registerBlock("basic_strength_chemistry_multiblock_energy_input_bus_block", () ->
            new BasicStrengthChemistryMultiblockEnergyInputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_CHEMISTRY_MULTIBLOCK_ITEM_INPUT_PORT_BLOCK = registerBlock("basic_strength_chemistry_multiblock_item_input_port_block", () ->
            new BasicStrengthChemistryMultiblockItemInputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_CHEMISTRY_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK = registerBlock("basic_strength_chemistry_multiblock_item_output_port_block", () ->
            new BasicStrengthChemistryMultiblockItemOutputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_DYNAMIC_ENERGETICS_MULTIBLOCK_ENERGY_STORAGE_BLOCK = registerBlock("basic_strength_dynamic_energetics_multiblock_energy_storage_block", () ->
            new BasicStrengthDynamicEnergeticsMultiblockEnergyStorageBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_ENGINEERING_MULTIBLOCK_ITEM_STORAGE_BLOCK = registerBlock("basic_strength_engineering_multiblock_item_storage_block", () ->
            new BasicStrengthEngineeringMultiblockItemStorageBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_ENGINEERING_MULTIBLOCK_ENERGY_INPUT_BUS_BLOCK = registerBlock("basic_strength_engineering_multiblock_energy_input_bus_block", () ->
            new BasicStrengthEngineeringMultiblockEnergyInputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_ENGINEERING_MULTIBLOCK_ENERGY_OUTPUT_BUS_BLOCK = registerBlock("basic_strength_engineering_multiblock_energy_output_bus_block", () ->
            new BasicStrengthEngineeringMultiblockEnergyOutputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_ENGINEERING_MULTIBLOCK_ITEM_INPUT_PORT_BLOCK = registerBlock("basic_strength_engineering_multiblock_item_input_port_block", () ->
            new BasicStrengthEngineeringMultiblockItemInputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_ENGINEERING_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK = registerBlock("basic_strength_engineering_multiblock_item_output_port_block", () ->
            new BasicStrengthEngineeringMultiblockItemOutputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_ITEM_STORAGE_BLOCK = registerBlock("basic_strength_formal_science_multiblock_item_storage_block", () ->
            new BasicStrengthFormalScienceMultiblockItemStorageBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_ENERGY_INPUT_BUS_BLOCK = registerBlock("basic_strength_formal_science_multiblock_energy_input_bus_block", () ->
            new BasicStrengthFormalScienceMultiblockEnergyInputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_ENERGY_OUTPUT_BUS_BLOCK = registerBlock("basic_strength_formal_science_multiblock_energy_output_bus_block", () ->
            new BasicStrengthFormalScienceMultiblockEnergyOutputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_ITEM_INPUT_PORT_BLOCK = registerBlock("basic_strength_formal_science_multiblock_item_input_port_block", () ->
            new BasicStrengthFormalScienceMultiblockItemInputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK = registerBlock("basic_strength_formal_science_multiblock_item_output_port_block", () ->
            new BasicStrengthFormalScienceMultiblockItemOutputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ITEM_STORAGE_BLOCK = registerBlock("basic_strength_geo_science_multiblock_item_storage_block", () ->
            new BasicStrengthGeoScienceMultiblockItemStorageBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ENERGY_INPUT_BUS_BLOCK = registerBlock("basic_strength_geo_science_multiblock_energy_input_bus_block", () ->
            new BasicStrengthGeoScienceMultiblockEnergyInputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ENERGY_OUTPUT_BUS_BLOCK = registerBlock("basic_strength_geo_science_multiblock_energy_output_bus_block", () ->
            new BasicStrengthGeoScienceMultiblockEnergyOutputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ITEM_INPUT_PORT_BLOCK = registerBlock("basic_strength_geo_science_multiblock_item_input_port_block", () ->
            new BasicStrengthGeoScienceMultiblockItemInputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK = registerBlock("basic_strength_geo_science_multiblock_item_output_port_block", () ->
            new BasicStrengthGeoScienceMultiblockItemOutputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_ITEM_STORAGE_BLOCK = registerBlock("basic_strength_imitation_magic_engineering_multiblock_item_storage_block", () ->
            new BasicStrengthImitationMagicEngineeringMultiblockItemStorageBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_ENERGY_INPUT_BUS_BLOCK = registerBlock("basic_strength_imitation_magic_engineering_multiblock_energy_input_bus_block", () ->
            new BasicStrengthImitationMagicEngineeringMultiblockEnergyInputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_ENERGY_OUTPUT_BUS_BLOCK = registerBlock("basic_strength_imitation_magic_engineering_multiblock_energy_output_bus_block", () ->
            new BasicStrengthImitationMagicEngineeringMultiblockEnergyOutputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_ITEM_INPUT_PORT_BLOCK = registerBlock("basic_strength_imitation_magic_engineering_multiblock_item_input_port_block", () ->
            new BasicStrengthImitationMagicEngineeringMultiblockItemInputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK = registerBlock("basic_strength_imitation_magic_engineering_multiblock_item_output_port_block", () ->
            new BasicStrengthImitationMagicEngineeringMultiblockItemOutputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_BLOCK = registerBlock("basic_strength_jenith_void_science_multiblock_energy_storage_block", () ->
            new BasicStrengthJenithVoidScienceMultiblockEnergyStorageBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_ITEM_STORAGE_BLOCK = registerBlock("basic_strength_jenith_void_science_multiblock_item_storage_block", () ->
            new BasicStrengthJenithVoidScienceMultiblockItemStorageBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_ENERGY_INPUT_BUS_BLOCK = registerBlock("basic_strength_jenith_void_science_multiblock_energy_input_bus_block", () ->
            new BasicStrengthJenithVoidScienceMultiblockEnergyInputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_ENERGY_OUTPUT_BUS_BLOCK = registerBlock("basic_strength_jenith_void_science_multiblock_energy_output_bus_block", () ->
            new BasicStrengthJenithVoidScienceMultiblockEnergyOutputBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_ITEM_INPUT_PORT_BLOCK = registerBlock("basic_strength_jenith_void_science_multiblock_item_input_port_block", () ->
            new BasicStrengthJenithVoidScienceMultiblockItemInputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK = registerBlock("basic_strength_jenith_void_science_multiblock_item_output_port_block", () ->
            new BasicStrengthJenithVoidScienceMultiblockItemOutputPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_STRENGTH_KALEIDOSCOPIC_REALITY_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_BLOCK = registerBlock("basic_strength_kaleidoscopic_reality_science_multiblock_energy_storage_block", () ->
            new BasicStrengthKaleidoscopicRealityScienceMultiblockEnergyStorageBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
...
//            DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_PRECISION_OBJECTIVE_LENS_HOLO_BLOCK = registerHoloBlock("basic_precision_objective_lens_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_PERFORMANCE_ASTRONOMICAL_TELESCOPE_BUS_BLOCK = registerBlock("basic_performance_astronomical_telescope_bus_block", () ->
            new BasicPerformanceAstronomicalTelescopeBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_PERFORMANCE_ASTRONOMICAL_TELESCOPE_BUS_HOLO_BLOCK = registerHoloBlock("basic_performance_astronomical_telescope_bus_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_PERFORMANCE_ASTRONOMICAL_TELESCOPE_PORT_BLOCK = registerBlock("basic_performance_astronomical_telescope_port_block", () ->
            new BasicPerformanceAstronomicalTelescopePortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    ...
    public static final RegistryObject<Block> BASIC_EFFICIENCY_FAINT_LIGHT_RESERVER_HOLO_BLOCK = registerHoloBlock("basic_efficiency_faint_light_receiver_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_PERFORMANCE_STARLIGHT_COLLECTOR_BUS_BLOCK = registerBlock("basic_performance_starlight_collector_bus_block", () ->
            new BasicPerformanceStarlightCollectorBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_PERFORMANCE_STARLIGHT_COLLECTOR_BUS_HOLO_BLOCK = registerHoloBlock("basic_performance_starlight_collector_bus_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_PERFORMANCE_STARLIGHT_COLLECTOR_PORT_BLOCK = registerBlock("basic_performance_starlight_collector_port_block", () ->
            new BasicPerformanceStarlightCollectorPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_PERFORMANCE_STARLIGHT_COLLECTOR_PORT_HOLO_BLOCK = registerHoloBlock("basic_performance_starlight_collector_port_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    ...
    public static final RegistryObject<Block> BASIC_SPEED_CULTIVATION_GREENHOUSE_HOLO_BLOCK = registerHoloBlock("basic_speed_cultivation_greenhouse_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_PERFORMANCE_BIO_REACTOR_BUS_BLOCK = registerBlock("basic_performance_bio_reactor_bus_block", () ->
            new BasicPerformanceBioReactorBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_PERFORMANCE_BIO_REACTOR_BUS_HOLO_BLOCK = registerHoloBlock("basic_performance_bio_reactor_bus_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    ...
    public static final RegistryObject<Block> BASIC_RATE_COMPOUND_AGITATION_SYSTEM_HOLO_BLOCK = registerHoloBlock("basic_rate_compound_agitation_system_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_PERFORMANCE_CHEMICAL_REACTOR_BUS_BLOCK = registerBlock("basic_performance_chemical_reactor_bus_block", () ->
            new BasicPerformanceChemicalReactorBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_PERFORMANCE_CHEMICAL_REACTOR_BUS_HOLO_BLOCK = registerHoloBlock("basic_performance_chemical_reactor_bus_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_PERFORMANCE_CHEMICAL_REACTOR_PORT_BLOCK = registerBlock("basic_performance_chemical_reactor_port_block", () ->
            new BasicPerformanceChemicalReactorPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_PERFORMANCE_CHEMICAL_REACTOR_PORT_HOLO_BLOCK = registerHoloBlock("basic_performance_chemical_reactor_port_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    ...
    public static final RegistryObject<Block> BASIC_PRESSURE_COMPRESSION_ASSIST_SYSTEM_BLOCK = registerTooltipMultiblockAbilityBlock(
            "basic_pressure_compression_assist_system_block", () ->
                    new BlockBase(BlockBehaviour.Properties.of(Material.METAL).strength(4.0f)), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB,
    ...
    public static final RegistryObject<Block> BASIC_PRESSURE_COMPRESSION_ASSIST_SYSTEM_HOLO_BLOCK = registerHoloBlock("basic_pressure_compression_assist_system_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_COMPRESSION_CONDENSER_BUS_BLOCK = registerBlock("basic_technology_compression_condenser_bus_block", () ->
            new BasicTechnologyCompressionCondenserBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_COMPRESSION_CONDENSER_BUS_HOLO_BLOCK = registerHoloBlock("basic_technology_compression_condenser_bus_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_COMPRESSION_CONDENSER_PORT_BLOCK = registerBlock("basic_technology_compression_condenser_port_block", () ->
            new BasicTechnologyCompressionCondenserPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_COMPRESSION_CONDENSER_PORT_HOLO_BLOCK = registerHoloBlock("basic_technology_compression_condenser_port_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    ...
    public static final RegistryObject<Block> BASIC_DURABLE_INSULATED_CHAMBER_HOLO_BLOCK = registerHoloBlock("basic_durable_insulated_chamber_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_ELECTROMAGNETIC_INDUCTOR_BUS_BLOCK = registerBlock("basic_technology_electromagnetic_inductor_bus_block", () ->
            new BasicTechnologyElectromagneticInductorBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_ELECTROMAGNETIC_INDUCTOR_BUS_HOLO_BLOCK = registerHoloBlock("basic_technology_electromagnetic_inductor_bus_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_ELECTROMAGNETIC_INDUCTOR_PORT_BLOCK = registerBlock("basic_technology_electromagnetic_inductor_port_block", () ->
            new BasicTechnologyElectromagneticInductorPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_ELECTROMAGNETIC_INDUCTOR_PORT_HOLO_BLOCK = registerHoloBlock("basic_technology_electromagnetic_inductor_port_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    ...
    public static final RegistryObject<Block> BASIC_PERFORMANCE_CIRCUIT_BUILDER_BLOCK = registerTooltipBasicMachineBlock("basic_performance_circuit_builder_block", () ->
                    new BasicPerformanceCircuitBuilderBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB,
            "Lv0:3×3×3",
            "Lv1:3×3×3",
            "Base:Speed ×1.00,Energy Usage ×1.00",
            "Lv0:Speed ×2.00,Energy Usage ×1.50",
    ...
    public static final RegistryObject<Block> BASIC_PURITY_CIRCUIT_CLEAN_ROOM_HOLO_BLOCK = registerHoloBlock("basic_purity_circuit_clean_room_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_PERFORMANCE_CIRCUIT_BUILDER_BUS_BLOCK = registerBlock("basic_performance_circuit_builder_bus_block", () ->
            new BasicPerformanceCircuitBuilderBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_PERFORMANCE_CIRCUIT_BUILDER_BUS_HOLO_BLOCK = registerHoloBlock("basic_performance_circuit_builder_bus_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_PERFORMANCE_CIRCUIT_BUILDER_PORT_BLOCK = registerBlock("basic_performance_circuit_builder_port_block", () ->
            new BasicPerformanceCircuitBuilderPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_PERFORMANCE_CIRCUIT_BUILDER_PORT_HOLO_BLOCK = registerHoloBlock("basic_performance_circuit_builder_port_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    ...
    public static final RegistryObject<Block> BASIC_PERFORMANCE_DESIGNATED_DATA_INJECTOR_BLOCK = registerTooltipBasicMachineBlock("basic_performance_designated_data_injector_block", () ->
                    new BasicPerformanceDesignatedDataInjectorBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB,
            "Lv0:3×3×3",
            "Lv1:3×3×3",
            "Base:Speed ×1.00,Energy Usage ×1.00",
            "Lv0:Speed ×2.00,Energy Usage ×1.50",
    ...
    public static final RegistryObject<Block> BASIC_SPEED_CALCULATION_AUXILIARY_WRITE_DEVICE_HOLO_BLOCK = registerHoloBlock("basic_speed_calculation_auxiliary_coder_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_PERFORMANCE_DESIGNATED_DATA_INJECTOR_BUS_BLOCK = registerBlock("basic_performance_designated_data_injector_bus_block", () ->
            new BasicPerformanceDesignatedDataInjectorBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_PERFORMANCE_DESIGNATED_DATA_INJECTOR_BUS_HOLO_BLOCK = registerHoloBlock("basic_performance_designated_data_injector_bus_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_PERFORMANCE_DESIGNATED_DATA_INJECTOR_PORT_BLOCK = registerBlock("basic_performance_designated_data_injector_port_block", () ->
            new BasicPerformanceDesignatedDataInjectorPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_PERFORMANCE_DESIGNATED_DATA_INJECTOR_PORT_HOLO_BLOCK = registerHoloBlock("basic_performance_designated_data_injector_port_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    ...
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_IMITATION_MAGIC_ENGRAVER_BLOCK = registerTooltipBasicMachineBlock("basic_technology_imitation_magic_engraver_block", () ->
                    new BasicTechnologyImitationMagicEngraverBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB,
            "Lv0:3×3×3",
            "Lv1:3×3×3",
            "Base:Speed ×1.00,Energy Usage ×1.00",
            "Lv0:Speed ×2.00,Energy Usage ×1.50",
    ...
    public static final RegistryObject<Block> BASIC_OUTPUT_MYSTIC_OPTICAL_PROJECTION_DEVICE_HOLO_BLOCK = registerHoloBlock("basic_output_mystic_optical_projection_device_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_IMITATION_MAGIC_ENGRAVER_BUS_BLOCK = registerBlock("basic_technology_imitation_magic_engraver_bus_block", () ->
            new BasicTechnologyImitationMagicEngraverBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_IMITATION_MAGIC_ENGRAVER_BUS_HOLO_BLOCK = registerHoloBlock("basic_technology_imitation_magic_engraver_bus_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_IMITATION_MAGIC_ENGRAVER_PORT_BLOCK = registerBlock("basic_technology_imitation_magic_engraver_port_block", () ->
            new BasicTechnologyImitationMagicEngraverPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_IMITATION_MAGIC_ENGRAVER_PORT_HOLO_BLOCK = registerHoloBlock("basic_technology_imitation_magic_engraver_port_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    ...
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_BLOCK = registerTooltipBasicMachineBlock("basic_technology_virtual_sigil_processor_block", () ->
                    new BasicTechnologyVirtualSigilProcessorBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB,
            "Lv0:3×3×3",
            "Lv1:3×3×3",
            "Base:Speed ×1.00,Energy Usage ×1.00",
            "Lv0:Speed ×2.00,Energy Usage ×1.50",
    ...
    public static final RegistryObject<Block> BASIC_SPEED_PATTERN_TRANSFER_SYSTEM_HOLO_BLOCK = registerHoloBlock("basic_speed_pattern_transfer_system_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_BUS_BLOCK = registerBlock("basic_technology_virtual_sigil_processor_bus_block", () ->
            new BasicTechnologyVirtualSigilProcessorBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_BUS_HOLO_BLOCK = registerHoloBlock("basic_technology_virtual_sigil_processor_bus_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_PORT_BLOCK = registerBlock("basic_technology_virtual_sigil_processor_port_block", () ->
            new BasicTechnologyVirtualSigilProcessorPortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_PORT_HOLO_BLOCK = registerHoloBlock("basic_technology_virtual_sigil_processor_port_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    ...
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_VOID_WORLD_COORDINATE_RECORDING_MACHINE_BLOCK = registerTooltipBasicMachineBlock("basic_technology_void_world_coordinate_recording_machine_block", () ->
                    new BasicTechnologyVoidWorldCoordinateRecordingMachineBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB,
            "Lv0:5×5×5",
            "Lv1:5×5×5",
            "Base:Speed ×1.00,Energy Usage ×1.00",
            "Lv0:Speed ×2.00,Energy Usage ×1.50",
    ...
    public static final RegistryObject<Block> BASIC_EFFICIENCY_VOID_INTERFERENCE_FLAME_HOLO_BLOCK = registerHoloBlock("basic_efficiency_void_interference_frame_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_VOID_WORLD_COORDINATE_RECORDING_MACHINE_BUS_BLOCK = registerBlock("basic_technology_void_world_coordinate_recording_machine_bus_block", () ->
            new BasicTechnologyVoidWorldCoordinateRecordingMachineBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_VOID_WORLD_COORDINATE_RECORDING_MACHINE_BUS_HOLO_BLOCK = registerHoloBlock("basic_technology_void_world_coordinate_recording_machine_bus_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_VOID_WORLD_COORDINATE_RECORDING_MACHINE_PORT_BLOCK = registerBlock("basic_technology_void_world_coordinate_recording_machine_port_block", () ->
            new BasicTechnologyVoidWorldCoordinateRecordingMachinePortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_TECHNOLOGY_VOID_WORLD_COORDINATE_RECORDING_MACHINE_PORT_HOLO_BLOCK = registerHoloBlock("basic_technology_void_world_coordinate_recording_machine_port_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    ...
    public static final RegistryObject<Block> BASIC_PERFORMANCE_REALITY_PHASE_ADJUSTMENT_MACHINE_BLOCK = registerTooltipBasicMachineBlock("basic_performance_reality_phase_adjustment_machine_block", () ->
                    new BasicPerformanceRealityPhaseAdjustmentMachineBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB,
            "Lv0:5×5×5",
            "Lv1:5×5×5",
            "Base:Speed ×1.00,Energy Usage ×1.00",
            "Lv0:Speed ×2.00,Energy Usage ×1.50",
    ...
    public static final RegistryObject<Block> BASIC_EFFICIENCY_PHASE_STABLE_FLAME_HOLO_BLOCK = registerHoloBlock("basic_efficiency_phase_stable_frame_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_PERFORMANCE_REALITY_PHASE_ADJUSTMENT_MACHINE_BUS_BLOCK = registerBlock("basic_performance_reality_phase_adjustment_machine_bus_block", () ->
            new BasicPerformanceRealityPhaseAdjustmentMachineBusBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_PERFORMANCE_REALITY_PHASE_ADJUSTMENT_MACHINE_BUS_HOLO_BLOCK = registerHoloBlock("basic_performance_reality_phase_adjustment_machine_bus_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
    public static final RegistryObject<Block> BASIC_PERFORMANCE_REALITY_PHASE_ADJUSTMENT_MACHINE_PORT_BLOCK = registerBlock("basic_performance_reality_phase_adjustment_machine_port_block", () ->
            new BasicPerformanceRealityPhaseAdjustmentMachinePortBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()), DCCreativeTab.DEGENERACYCRAFT_MACHINE_TAB);
    public static final RegistryObject<Block> BASIC_PERFORMANCE_REALITY_PHASE_ADJUSTMENT_MACHINE_PORT_HOLO_BLOCK = registerHoloBlock("basic_performance_reality_phase_adjustment_machine_port_holo_block", () ->
            new DCHoloBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).destroyTime(0.0F).strength(0.0F)));
                ...
                if (Screen.hasShiftDown()) {
                    ...
                    switch (scienceName) {
                        ...
                        case "dynamic_energetics" ->
                                pTooltip.add(new TranslatableComponent("tooltip.degeneracycraft.science." + scienceName).withStyle(ChatFormatting.GRAY));
                        case "engineering" ->
                        ...
                        case "jenith_void_science" ->
                                pTooltip.add(new TranslatableComponent("tooltip.degeneracycraft.science." + scienceName).withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting.UNDERLINE).withStyle(ChatFormatting.BLACK));
                        case "kaleidoscopic_reality_science" ->
                                pTooltip.add(new TranslatableComponent("tooltip.degeneracycraft.science." + scienceName).withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting.UNDERLINE).withStyle(ChatFormatting.GOLD));
                       }
                    switch (phase) {
                        case "initial" ->
