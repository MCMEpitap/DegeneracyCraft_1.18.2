...
public class BasicPerformanceFineParticleAdsorberScreen extends AbstractContainerScreen<BasicPerformanceFineParticleAdsorberMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/astronomy/basic_performance_fine_particle_adsorber/basic_performance_fine_particle_adsorber_gui.png");
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceFineParticleAdsorberBlockEntity.isHaltDevice(menu.blockEntity)) {
