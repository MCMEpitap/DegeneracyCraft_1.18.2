...
public class BasicPerformanceFineParticleAdsorberStructure {
    ...
    public BasicPerformanceFineParticleAdsorberStructure() {
    }

    public static boolean isFormed(Level level, BlockPos pos, BlockState state, BasicPerformanceFineParticleAdsorberBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceFineParticleAdsorberBlock.FACING);
    ...
    public static boolean isPowered0(Level level, BlockPos pos, BlockState state, BasicPerformanceFineParticleAdsorberBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceFineParticleAdsorberBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
...
//        blockConditions.put("G", blockState -> blockState.is(DCBlocks.BASIC_STRENGTH_ASTRONOMY_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get()));
    ...
    public static void hologram(Level level, BlockPos pos, BlockState state, BasicPerformanceFineParticleAdsorberBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceFineParticleAdsorberBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
        ...
        blockMapping.put("P", DCBlocks.BASIC_PERFORMANCE_FINE_PARTICLE_ADSORBER_PORT_HOLO_BLOCK);
        blockMapping.put("S", DCBlocks.BASIC_STRENGTH_ASTRONOMY_MULTIBLOCK_MATERIAL_STORAGE_HOLO_BLOCK);
        blockMapping.put("B", DCBlocks.BASIC_PERFORMANCE_FINE_PARTICLE_ADSORBER_BUS_HOLO_BLOCK);
        ...
        blockMapping.put("T", DCBlocks.BASIC_EFFICIENCY_FINE_PARTICLE_STORAGE_TANK_HOLO_BLOCK);
    ...
    private static boolean isExpectedBlock(BlockState blockState, String blockKey) {
        return switch (blockKey) {
            ...
            case "P" -> blockState.is(DCBlocks.BASIC_PERFORMANCE_FINE_PARTICLE_ADSORBER_PORT_BLOCK.get());
            case "S" -> blockState.is(DCBlocks.BASIC_STRENGTH_ASTRONOMY_MULTIBLOCK_MATERIAL_STORAGE_BLOCK.get());
            case "B" -> blockState.is(DCBlocks.BASIC_PERFORMANCE_FINE_PARTICLE_ADSORBER_BUS_BLOCK.get());
            ...
            case "T" -> blockState.is(DCBlocks.BASIC_EFFICIENCY_FINE_PARTICLE_STORAGE_TANK_BLOCK.get());
            default -> false;
        };
    }
