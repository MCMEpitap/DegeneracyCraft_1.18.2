...
public class BasicPerformanceStarlightCollectorScreen extends AbstractContainerScreen<BasicPerformanceStarlightCollectorMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/astronomy/basic_performance_starlight_collector/basic_performance_starlight_collector_gui.png");
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceStarlightCollectorBlockEntity.isHaltDevice(menu.blockEntity)) {
