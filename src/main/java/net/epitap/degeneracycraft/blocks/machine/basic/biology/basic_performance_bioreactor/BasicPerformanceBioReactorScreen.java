...
public class BasicPerformanceBioReactorScreen extends AbstractContainerScreen<BasicPerformanceBioReactorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/biology/basic_performance_bio_reactor/basic_performance_bio_reactor_gui.png");
    private EnergyInfoArea energyInfoArea;


    public BasicPerformanceBioReactorScreen(BasicPerformanceBioReactorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceBioReactorBlockEntity.isHaltDevice(menu.blockEntity)) {
