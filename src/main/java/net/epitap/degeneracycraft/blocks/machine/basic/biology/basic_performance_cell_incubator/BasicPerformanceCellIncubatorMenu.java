...
public class BasicPerformanceCellIncubatorMenu extends AbstractContainerMenu {
    ...
    public final BasicPerformanceCellIncubatorBlockEntity blockEntity;
    ...
    public BasicPerformanceCellIncubatorMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        blockEntity = (BasicPerformanceCellIncubatorBlockEntity) entity;
    ...
    public BasicPerformanceCellIncubatorBlockEntity getBlockEntity() {
