...
public class BasicPerformanceCellIncubatorScreen extends AbstractContainerScreen<BasicPerformanceCellIncubatorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/biology/basic_performance_cell_incubator/basic_performance_cell_incubator_gui.png");
    private EnergyInfoArea energyInfoArea;


    public BasicPerformanceCellIncubatorScreen(BasicPerformanceCellIncubatorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceCellIncubatorBlockEntity.isHaltDevice(menu.blockEntity)) {
