...
public class BasicPerformanceCropCultivatorMenu extends AbstractContainerMenu {
    ...
    public final BasicPerformanceCropCultivatorBlockEntity blockEntity;
    ...
    public BasicPerformanceCropCultivatorBlockEntity getBlockEntity() {
