...
public class BasicPerformanceCropCultivatorScreen extends AbstractContainerScreen<BasicPerformanceCropCultivatorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/biology/basic_performance_crop_cultivator/basic_performance_crop_cultivator_gui.png");
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceCropCultivatorBlockEntity.isHaltDevice(menu.blockEntity)) {
