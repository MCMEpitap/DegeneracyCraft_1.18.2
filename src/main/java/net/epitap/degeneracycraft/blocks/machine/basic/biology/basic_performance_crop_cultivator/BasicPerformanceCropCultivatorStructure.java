package net.epitap.degeneracycraft.blocks.machine.basic.biology.basic_performance_crop_cultivator;
...
public class BasicPerformanceCropCultivatorStructure {
    ...
    public BasicPerformanceCropCultivatorStructure() {
    }


    public static boolean isFormed(Level level, BlockPos pos, BlockState state, BasicPerformanceCropCultivatorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceCropCultivatorBlock.FACING);
        ...
        blockConditions.put("F", blockState -> blockState.is(DCBlocks.BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get()));
        blockConditions.put("G", blockState -> blockState.is(DCBlocks.BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get()));
        blockConditions.put("P", blockState -> blockState.is(DCBlocks.BASIC_PERFORMANCE_CROP_CULTIVATOR_PORT_BLOCK.get()));
        blockConditions.put("S", blockState -> blockState.is(DCBlocks.BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_MATERIAL_STORAGE_BLOCK.get()));
        blockConditions.put("B", blockState -> blockState.is(DCBlocks.BASIC_PERFORMANCE_CROP_CULTIVATOR_BUS_BLOCK.get()));
    ...
    public static boolean isPowered0(Level level, BlockPos pos, BlockState state, BasicPerformanceCropCultivatorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceCropCultivatorBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
        ...
        blockConditions.put("B", blockState -> blockState.is(DCBlocks.BASIC_PERFORMANCE_CROP_CULTIVATOR_BUS_BLOCK.get()));
        blockConditions.put("E", blockState -> blockState.is(DCBlocks.BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get()));
        blockConditions.put("D", blockState -> blockState.is(DCBlocks.BASIC_EFFICIENCY_GROWTH_STABILIZER_BLOCK.get()));
    ...
    public static void hologram(Level level, BlockPos pos, BlockState state, BasicPerformanceCropCultivatorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceCropCultivatorBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
        ...
        blockMapping.put("F", DCBlocks.BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK);
        blockMapping.put("P", DCBlocks.BASIC_PERFORMANCE_CROP_CULTIVATOR_PORT_HOLO_BLOCK);
        blockMapping.put("S", DCBlocks.BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_MATERIAL_STORAGE_HOLO_BLOCK);
        blockMapping.put("B", DCBlocks.BASIC_PERFORMANCE_CROP_CULTIVATOR_BUS_HOLO_BLOCK);
        blockMapping.put("E", DCBlocks.BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_ENERGY_STORAGE_HOLO_BLOCK);
        blockMapping.put("D", DCBlocks.BASIC_EFFICIENCY_GROWTH_STABILIZER_HOLO_BLOCK);
    ...
    private static boolean isExpectedBlock(BlockState blockState, String blockKey) {
        return switch (blockKey) {
            case "F" -> blockState.is(DCBlocks.BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get());
            case "G" -> blockState.is(DCBlocks.BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get());
            case "P" -> blockState.is(DCBlocks.BASIC_PERFORMANCE_CROP_CULTIVATOR_PORT_BLOCK.get());
            case "S" -> blockState.is(DCBlocks.BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_MATERIAL_STORAGE_BLOCK.get());
            case "B" -> blockState.is(DCBlocks.BASIC_PERFORMANCE_CROP_CULTIVATOR_BUS_BLOCK.get());
            case "E" -> blockState.is(DCBlocks.BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get());
            case "D" -> blockState.is(DCBlocks.BASIC_EFFICIENCY_GROWTH_STABILIZER_BLOCK.get());
            default -> false;
        };
    }
