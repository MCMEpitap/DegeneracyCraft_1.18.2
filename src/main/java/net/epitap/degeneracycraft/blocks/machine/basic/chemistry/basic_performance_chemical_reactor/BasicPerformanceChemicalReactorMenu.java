...
public class BasicPerformanceChemicalReactorMenu extends AbstractContainerMenu {
    ...
    public BasicPerformanceChemicalReactorMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.BASIC_PERFORMANCE_CHEMICAL_REACTOR_MENU.get(), id);
        blockEntity = (BasicPerformanceChemicalReactorBlockEntity) entity;
    ...
    public BasicPerformanceChemicalReactorBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.BASIC_PERFORMANCE_CHEMICAL_REACTOR_BLOCK.get());
    }
