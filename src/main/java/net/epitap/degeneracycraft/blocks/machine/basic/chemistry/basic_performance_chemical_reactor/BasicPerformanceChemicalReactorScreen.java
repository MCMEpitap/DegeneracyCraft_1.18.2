...
public class BasicPerformanceChemicalReactorScreen extends AbstractContainerScreen<BasicPerformanceChemicalReactorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/chemistry/basic_performance_chemical_reactor/basic_performance_chemical_reactor_gui.png");
    private EnergyInfoArea energyInfoArea;


    public BasicPerformanceChemicalReactorScreen(BasicPerformanceChemicalReactorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceChemicalReactorBlockEntity.isHaltDevice(menu.blockEntity)) {
