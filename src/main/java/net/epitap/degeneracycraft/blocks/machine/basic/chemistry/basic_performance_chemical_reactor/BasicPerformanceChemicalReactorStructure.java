...
public class BasicPerformanceChemicalReactorStructure {
    ...
    public BasicPerformanceChemicalReactorStructure() {
    }


    public static boolean isFormed(Level level, BlockPos pos, BlockState state, BasicPerformanceChemicalReactorBlockEntity blockEntity) {
        ...
        blockConditions.put("P", blockState -> blockState.is(DCBlocks.BASIC_PERFORMANCE_CHEMICAL_REACTOR_PORT_BLOCK.get()));
        ...
        blockConditions.put("B", blockState -> blockState.is(DCBlocks.BASIC_PERFORMANCE_CHEMICAL_REACTOR_BUS_BLOCK.get()));
    ...
    public static boolean isPowered0(Level level, BlockPos pos, BlockState state, BasicPerformanceChemicalReactorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceChemicalReactorBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    public static void hologram(Level level, BlockPos pos, BlockState state, BasicPerformanceChemicalReactorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceChemicalReactorBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
        ...
        blockMapping.put("P", DCBlocks.BASIC_PERFORMANCE_CHEMICAL_REACTOR_PORT_HOLO_BLOCK);
        ...
        blockMapping.put("B", DCBlocks.BASIC_PERFORMANCE_CHEMICAL_REACTOR_BUS_HOLO_BLOCK);
        ...
        boolean displayHologram = blockEntity.itemHandler.getStackInSlot(8).is(DCItems.MULTIBLOCK_STRUCTURE_HOLOGRAM_VISUALIZER.get()) ||
                blockEntity.itemHandler.getStackInSlot(8).is(DCItems.BASIC_TECHNOLOGY_MULTIBLOCK_STRUCTURE_HOLOGRAM_VISUALIZER.get());

        if (!displayHologram) {
            removeHolograms(level, basePos, facing, blockMapping);
            return;
        }
        boolean visualizer0 = blockEntity.itemHandler.getStackInSlot(8).is(DCItems.MULTIBLOCK_STRUCTURE_HOLOGRAM_VISUALIZER.get());
        boolean visualizer1 = blockEntity.itemHandler.getStackInSlot(8).is(DCItems.BASIC_TECHNOLOGY_MULTIBLOCK_STRUCTURE_HOLOGRAM_VISUALIZER.get());
    ...
    private static boolean isExpectedBlock(BlockState blockState, String blockKey) {
        return switch (blockKey) {
            ...
            case "P" -> blockState.is(DCBlocks.BASIC_PERFORMANCE_CHEMICAL_REACTOR_PORT_BLOCK.get());
            ...
            case "B" -> blockState.is(DCBlocks.BASIC_PERFORMANCE_CHEMICAL_REACTOR_BUS_BLOCK.get());
