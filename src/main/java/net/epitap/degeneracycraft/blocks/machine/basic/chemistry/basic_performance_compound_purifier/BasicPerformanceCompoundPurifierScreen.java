...
public class BasicPerformanceCompoundPurifierScreen extends AbstractContainerScreen<BasicPerformanceCompoundPurifierMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/chemistry/basic_performance_compound_purifier/basic_performance_compound_purifier_gui.png");
    private EnergyInfoArea energyInfoArea;


    public BasicPerformanceCompoundPurifierScreen(BasicPerformanceCompoundPurifierMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceCompoundPurifierBlockEntity.isHaltDevice(menu.blockEntity)) {
