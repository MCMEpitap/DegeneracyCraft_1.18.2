...
public class BasicPerformanceCompoundPurifierStructure {
    ...
    public BasicPerformanceCompoundPurifierStructure() {
    }
    ...
    public static boolean isPowered0(Level level, BlockPos pos, BlockState state, BasicPerformanceCompoundPurifierBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceCompoundPurifierBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
