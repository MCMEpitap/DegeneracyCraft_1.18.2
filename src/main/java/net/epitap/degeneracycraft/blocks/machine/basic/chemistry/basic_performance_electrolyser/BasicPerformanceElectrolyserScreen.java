...
public class BasicPerformanceElectrolyserScreen extends AbstractContainerScreen<BasicPerformanceElectrolyserMenu> {
    ...
    public BasicPerformanceElectrolyserScreen(BasicPerformanceElectrolyserMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceElectrolyserBlockEntity.isHaltDevice(menu.blockEntity)) {
