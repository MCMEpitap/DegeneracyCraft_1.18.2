...
public class BasicTechnologyCompressionCondenserMenu extends AbstractContainerMenu {
    ...
    public final BasicTechnologyCompressionCondenserBlockEntity blockEntity;
    ...
    public BasicTechnologyCompressionCondenserMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        blockEntity = (BasicTechnologyCompressionCondenserBlockEntity) entity;
    ...
    public BasicTechnologyCompressionCondenserBlockEntity getBlockEntity() {
