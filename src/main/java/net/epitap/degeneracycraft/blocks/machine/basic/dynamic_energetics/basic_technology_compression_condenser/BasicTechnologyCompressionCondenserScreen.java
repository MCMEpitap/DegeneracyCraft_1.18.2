...
public class BasicTechnologyCompressionCondenserScreen extends AbstractContainerScreen<BasicTechnologyCompressionCondenserMenu> {
    ...
    public BasicTechnologyCompressionCondenserScreen(BasicTechnologyCompressionCondenserMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicTechnologyCompressionCondenserBlockEntity.isHaltDevice(menu.blockEntity)) {
