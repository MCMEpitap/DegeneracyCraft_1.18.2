...
public class BasicTechnologyElectromagneticInductorStructure {
    ...
    public static boolean isPowered1(Level level, BlockPos pos, BlockState state, BasicTechnologyElectromagneticInductorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyElectromagneticInductorBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    private static @NotNull Map<String, Supplier<BlockState>> getHoloBlockSuppliers() {
        ...
        blockSuppliers.put("P", () -> DCBlocks.BASIC_TECHNOLOGY_ELECTROMAGNETIC_INDUCTOR_PORT_HOLO_BLOCK.get().defaultBlockState());
        ...
        blockSuppliers.put("B", () -> DCBlocks.BASIC_TECHNOLOGY_ELECTROMAGNETIC_INDUCTOR_BUS_HOLO_BLOCK.get().defaultBlockState());
