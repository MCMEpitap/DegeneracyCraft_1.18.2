...
public class BasicTechnologyCircuitBuilderStructure {
    ...
    public BasicTechnologyCircuitBuilderStructure() {
    }
    ...
    public static boolean isFormed(Level level, BlockPos pos, BlockState state, BasicTechnologyCircuitBuilderBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyCircuitBuilderBlock.FACING);
        ...
        blockConditions.put("P", blockState -> blockState.is(DCBlocks.BASIC_TECHNOLOGY_CIRCUIT_BUILDER_PORT_BLOCK.get()));
        ...
        blockConditions.put("B", blockState -> blockState.is(DCBlocks.BASIC_TECHNOLOGY_CIRCUIT_BUILDER_BUS_BLOCK.get()));
    ...
    public static void hologram(Level level, BlockPos pos, BlockState state, BasicTechnologyCircuitBuilderBlockEntity blockEntity) {
        ...
        blockMapping.put("P", DCBlocks.BASIC_TECHNOLOGY_CIRCUIT_BUILDER_PORT_HOLO_BLOCK);
        ...
        blockMapping.put("B", DCBlocks.BASIC_TECHNOLOGY_CIRCUIT_BUILDER_BUS_HOLO_BLOCK);
    ...
    private static boolean isExpectedBlock(BlockState blockState, String blockKey) {
        return switch (blockKey) {
            ...
            case "P" -> blockState.is(DCBlocks.BASIC_TECHNOLOGY_CIRCUIT_BUILDER_PORT_BLOCK.get());
            ...
            case "B" -> blockState.is(DCBlocks.BASIC_TECHNOLOGY_CIRCUIT_BUILDER_BUS_BLOCK.get());
