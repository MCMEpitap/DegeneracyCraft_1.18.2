package net.epitap.degeneracycraft.blocks.machine.basic.engineering.basic_technology_machine_element_processor;
...
public class BasicTechnologyMachineElementProcessorStructure {
    ...
    public static boolean isPowered1(Level level, BlockPos pos, BlockState state, BasicTechnologyMachineElementProcessorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyMachineElementProcessorBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    private static @NotNull Map<String, Predicate<BlockState>> getBlockConditions() {
        ...
        blockConditions.put("C", blockState -> blockState.is(DCBlocks.BASIC_EFFICIENCY_MACHINE_ELEMENT_PROCESSING_CHAMBER_BLOCK.get()));
