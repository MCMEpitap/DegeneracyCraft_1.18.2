...
public class BasicTechnologyMachineElementProcessorStructure {
    ...
    public BasicTechnologyMachineElementProcessorStructure() {
    }
    ...
    public static boolean isPowered0(Level level, BlockPos pos, BlockState state, BasicTechnologyMachineElementProcessorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyMachineElementProcessorBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    private static boolean isExpectedBlock(BlockState blockState, String blockKey) {
        return switch (blockKey) {
            ...
            case "C" -> blockState.is(DCBlocks.BASIC_EFFICIENCY_MACHINE_ELEMENT_PROCESSING_CHAMBER_BLOCK.get());
            default -> false;
        };
    }
