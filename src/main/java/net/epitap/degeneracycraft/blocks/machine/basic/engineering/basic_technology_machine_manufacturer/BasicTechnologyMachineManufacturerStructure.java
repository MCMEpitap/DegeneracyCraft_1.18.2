...
public class BasicTechnologyMachineManufacturerStructure {
    ...
    public static boolean isFormed(Level level, BlockPos pos, BlockState state, BasicTechnologyMachineManufacturerBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyMachineManufacturerBlock.FACING);
    ...
    public static boolean isPowered1(Level level, BlockPos pos, BlockState state, BasicTechnologyMachineManufacturerBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyMachineManufacturerBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    private static @NotNull Map<String, Predicate<BlockState>> getBlockConditions() {
        ...
        blockConditions.put("C", blockState -> blockState.is(DCBlocks.BASIC_EFFICIENCY_MACHINE_PROCESSING_CHAMBER_BLOCK.get()));
