...
public class BasicTechnologyMachinePartProcessorMenu extends AbstractContainerMenu {
    ...
    public final BasicTechnologyMachinePartProcessorBlockEntity blockEntity;
    public final Level level;
    public final ContainerData data;

    public BasicTechnologyMachinePartProcessorMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public BasicTechnologyMachinePartProcessorMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.BASIC_TECHNOLOGY_MACHINE_PART_PROCESSOR_MACHINE_MENU.get(), id);
        blockEntity = (BasicTechnologyMachinePartProcessorBlockEntity) entity;
    ...
    public BasicTechnologyMachinePartProcessorBlockEntity getBlockEntity() {
