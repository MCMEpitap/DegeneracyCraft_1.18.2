...
public class BasicTechnologyMachinePartProcessorScreen extends AbstractContainerScreen<BasicTechnologyMachinePartProcessorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/engineering/basic_technology_machine_part_processor/basic_technology_machine_part_processor_gui.png");
    private EnergyInfoArea energyInfoArea;


    public BasicTechnologyMachinePartProcessorScreen(BasicTechnologyMachinePartProcessorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
