...
public class BasicTechnologyMachinePartProcessorStructure {
    ...
    public static boolean isFormed(Level level, BlockPos pos, BlockState state, BasicTechnologyMachinePartProcessorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyMachinePartProcessorBlock.FACING);
    ...
    public static boolean isPowered1(Level level, BlockPos pos, BlockState state, BasicTechnologyMachinePartProcessorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyMachinePartProcessorBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    public static void hologram(Level level, BlockPos pos, BlockState state, BasicTechnologyMachinePartProcessorBlockEntity blockEntity) {
    ...
    private static @NotNull Map<String, Supplier<BlockState>> getHoloBlockSuppliers() {
        ...
        blockSuppliers.put("C", () -> DCBlocks.BASIC_EFFICIENCY_MACHINE_PART_PROCESSING_CHAMBER_HOLO_BLOCK.get().defaultBlockState());
