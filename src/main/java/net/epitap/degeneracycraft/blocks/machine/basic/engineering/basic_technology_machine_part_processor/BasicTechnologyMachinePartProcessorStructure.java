...
public class BasicTechnologyMachinePartProcessorStructure {
    ...
    public BasicTechnologyMachinePartProcessorStructure() {
    }
    ...
    public static boolean isPowered0(Level level, BlockPos pos, BlockState state, BasicTechnologyMachinePartProcessorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyMachinePartProcessorBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
