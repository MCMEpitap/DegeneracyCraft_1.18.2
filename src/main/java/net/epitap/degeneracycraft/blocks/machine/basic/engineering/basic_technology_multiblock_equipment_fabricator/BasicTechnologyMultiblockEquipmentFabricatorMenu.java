...
public class BasicTechnologyMultiblockEquipmentFabricatorMenu extends AbstractContainerMenu {
    ...
    public final BasicTechnologyMultiblockEquipmentFabricatorBlockEntity blockEntity;
    ...
    public BasicTechnologyMultiblockEquipmentFabricatorMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.BASIC_TECHNOLOGY_MULTIBLOCK_EQUIPMENT_FABRICATOR_MENU.get(), id);
        blockEntity = (BasicTechnologyMultiblockEquipmentFabricatorBlockEntity) entity;
    ...
    public BasicTechnologyMultiblockEquipmentFabricatorBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.BASIC_TECHNOLOGY_MULTIBLOCK_EQUIPMENT_FABRICATOR_BLOCK.get());
    }
