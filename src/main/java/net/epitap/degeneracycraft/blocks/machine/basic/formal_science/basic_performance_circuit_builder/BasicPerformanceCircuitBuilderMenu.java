...
public class BasicPerformanceCircuitBuilderMenu extends AbstractContainerMenu {
    ...
    public BasicPerformanceCircuitBuilderMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.BASIC_PERFORMANCE_CIRCUIT_BUILDER_MENU.get(), pContainerId);
        blockEntity = ((BasicPerformanceCircuitBuilderBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, DCBlocks.BASIC_PERFORMANCE_CIRCUIT_BUILDER_BLOCK.get());
    }
