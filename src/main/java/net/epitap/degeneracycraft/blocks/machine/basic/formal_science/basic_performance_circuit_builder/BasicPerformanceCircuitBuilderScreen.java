...
public class BasicPerformanceCircuitBuilderScreen extends AbstractContainerScreen<BasicPerformanceCircuitBuilderMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/formal_science/basic_performance_circuit_builder/basic_performance_circuit_builder_gui.png");
    private EnergyInfoArea energyInfoArea;


    public BasicPerformanceCircuitBuilderScreen(BasicPerformanceCircuitBuilderMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceCircuitBuilderBlockEntity.isHaltDevice(menu.blockEntity)) {
