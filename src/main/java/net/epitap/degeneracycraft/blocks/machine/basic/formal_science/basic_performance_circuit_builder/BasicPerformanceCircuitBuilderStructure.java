...
public class BasicPerformanceCircuitBuilderStructure {
    ...
    public BasicPerformanceCircuitBuilderStructure() {
    }
    ...
    public static boolean isPowered0(Level level, BlockPos pos, BlockState state, BasicPerformanceCircuitBuilderBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceCircuitBuilderBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    public static void hologram(Level level, BlockPos pos, BlockState state, BasicPerformanceCircuitBuilderBlockEntity blockEntity) {
        ...
        blockMapping.put("P", DCBlocks.BASIC_PERFORMANCE_CIRCUIT_BUILDER_PORT_HOLO_BLOCK);
        blockMapping.put("S", DCBlocks.BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_MATERIAL_STORAGE_HOLO_BLOCK);
        blockMapping.put("B", DCBlocks.BASIC_PERFORMANCE_CIRCUIT_BUILDER_BUS_HOLO_BLOCK);
    ...
    private static boolean isExpectedBlock(BlockState blockState, String blockKey) {
        return switch (blockKey) {
            ...
            case "P" -> blockState.is(DCBlocks.BASIC_PERFORMANCE_CIRCUIT_BUILDER_PORT_BLOCK.get());
            case "S" -> blockState.is(DCBlocks.BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_MATERIAL_STORAGE_BLOCK.get());
            case "B" -> blockState.is(DCBlocks.BASIC_PERFORMANCE_CIRCUIT_BUILDER_BUS_BLOCK.get());
            case "E" -> blockState.is(DCBlocks.BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get());
            case "C" -> blockState.is(DCBlocks.BASIC_PURITY_CIRCUIT_CLEAN_ROOM_BLOCK.get());
            default -> false;
        };
    }
