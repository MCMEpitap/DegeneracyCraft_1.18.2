...
public class BasicPerformanceDesignatedDataInjectorScreen extends AbstractContainerScreen<BasicPerformanceDesignatedDataInjectorMenu> {
    ...
    public BasicPerformanceDesignatedDataInjectorScreen(BasicPerformanceDesignatedDataInjectorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceDesignatedDataInjectorBlockEntity.isHaltDevice(menu.blockEntity)) {
