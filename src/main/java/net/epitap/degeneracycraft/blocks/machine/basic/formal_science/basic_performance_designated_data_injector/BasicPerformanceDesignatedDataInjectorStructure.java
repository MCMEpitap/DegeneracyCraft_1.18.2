...
public class BasicPerformanceDesignatedDataInjectorStructure {
    ...
    public static boolean isFormed(Level level, BlockPos pos, BlockState state, BasicPerformanceDesignatedDataInjectorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceDesignatedDataInjectorBlock.FACING);
    ...
    public static boolean isPowered1(Level level, BlockPos pos, BlockState state, BasicPerformanceDesignatedDataInjectorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceDesignatedDataInjectorBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    private static @NotNull Map<String, Predicate<BlockState>> getBlockConditions() {
        ...
        blockConditions.put("C", blockState -> blockState.is(DCBlocks.BASIC_SPEED_CALCULATION_AUXILIARY_WRITE_DEVICE_BLOCK.get()));
    ...
    public static void hologram(Level level, BlockPos pos, BlockState state, BasicPerformanceDesignatedDataInjectorBlockEntity blockEntity) {
    ...
    private static @NotNull Map<String, Supplier<BlockState>> getHoloBlockSuppliers() {
        ...
        blockSuppliers.put("C", () -> DCBlocks.BASIC_SPEED_CALCULATION_AUXILIARY_WRITE_DEVICE_BLOCK.get().defaultBlockState());
