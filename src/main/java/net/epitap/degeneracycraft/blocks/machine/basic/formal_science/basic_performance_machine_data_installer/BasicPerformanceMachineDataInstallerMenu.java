...
public class BasicPerformanceMachineDataInstallerMenu extends AbstractContainerMenu {
    ...
    public final BasicPerformanceMachineDataInstallerBlockEntity blockEntity;
    ...
    public BasicPerformanceMachineDataInstallerBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.BASIC_PERFORMANCE_MACHINE_DATA_INSTALLER_BLOCK.get());
    }
