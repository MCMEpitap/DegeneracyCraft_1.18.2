...
public class BasicPerformanceMachineDataInstallerScreen extends AbstractContainerScreen<BasicPerformanceMachineDataInstallerMenu> {
    ...
    public BasicPerformanceMachineDataInstallerScreen(BasicPerformanceMachineDataInstallerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceMachineDataInstallerBlockEntity.isHaltDevice(menu.blockEntity)) {
