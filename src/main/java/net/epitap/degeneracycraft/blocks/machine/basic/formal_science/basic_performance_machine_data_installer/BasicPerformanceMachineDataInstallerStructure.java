...
public class BasicPerformanceMachineDataInstallerStructure {
    ...
    public static boolean isPowered1(Level level, BlockPos pos, BlockState state, BasicPerformanceMachineDataInstallerBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceMachineDataInstallerBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    private static @NotNull Map<String, Supplier<BlockState>> getHoloBlockSuppliers() {
        ...
        blockSuppliers.put("R", () -> DCBlocks.BASIC_SPEED_DATA_READER_HOLO_BLOCK.get().defaultBlockState());
