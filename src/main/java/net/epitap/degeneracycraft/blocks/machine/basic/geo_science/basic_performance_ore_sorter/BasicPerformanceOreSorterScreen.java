...
public class BasicPerformanceOreSorterScreen extends AbstractContainerScreen<BasicPerformanceOreSorterMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/geo_science/basic_performance_ore_sorter/basic_performance_ore_sorter_gui.png");
    private EnergyInfoArea energyInfoArea;


    public BasicPerformanceOreSorterScreen(BasicPerformanceOreSorterMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceOreSorterBlockEntity.isHaltDevice(menu.blockEntity)) {
