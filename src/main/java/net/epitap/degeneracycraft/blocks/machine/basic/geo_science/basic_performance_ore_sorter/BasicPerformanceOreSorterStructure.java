package net.epitap.degeneracycraft.blocks.machine.basic.geo_science.basic_performance_ore_sorter;
...
public class BasicPerformanceOreSorterStructure {
    ...
    public BasicPerformanceOreSorterStructure() {
    }


    public static boolean isFormed(Level level, BlockPos pos, BlockState state, BasicPerformanceOreSorterBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceOreSorterBlock.FACING);
    ...
    public static boolean isPowered0(Level level, BlockPos pos, BlockState state, BasicPerformanceOreSorterBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceOreSorterBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    public static void hologram(Level level, BlockPos pos, BlockState state, BasicPerformanceOreSorterBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceOreSorterBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
        ...
        blockMapping.put("G", DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_STRUCTURE_GLASS_HOLO_BLOCK);
        blockMapping.put("P", DCBlocks.BASIC_PERFORMANCE_ORE_SORTER_PORT_HOLO_BLOCK);
        blockMapping.put("S", DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_MATERIAL_STORAGE_HOLO_BLOCK);
        blockMapping.put("B", DCBlocks.BASIC_PERFORMANCE_ORE_SORTER_BUS_HOLO_BLOCK);
        blockMapping.put("E", DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_HOLO_BLOCK);
        blockMapping.put("O", DCBlocks.BASIC_CRASHING_BASE_HOLO_BLOCK);
    ...
    private static boolean isExpectedBlock(BlockState blockState, String blockKey) {
        return switch (blockKey) {
            ...
            case "G" -> blockState.is(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get());
            case "P" -> blockState.is(DCBlocks.BASIC_PERFORMANCE_ORE_SORTER_PORT_BLOCK.get());
            case "S" -> blockState.is(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_MATERIAL_STORAGE_BLOCK.get());
            case "B" -> blockState.is(DCBlocks.BASIC_PERFORMANCE_ORE_SORTER_BUS_BLOCK.get());
            case "E" -> blockState.is(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get());
            case "O" -> blockState.is(DCBlocks.BASIC_CRASHING_BASE_BLOCK.get());
            default -> false;
        };
    }
