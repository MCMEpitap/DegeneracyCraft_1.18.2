...
public class BasicPerformanceRockCrasherMenu extends AbstractContainerMenu {
    ...
    public final BasicPerformanceRockCrasherBlockEntity blockEntity;
    public final Level level;
    public final ContainerData data;

    public BasicPerformanceRockCrasherMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public BasicPerformanceRockCrasherMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.BASIC_PERFORMANCE_ROCK_CRASHER_MENU.get(), id);
        blockEntity = (BasicPerformanceRockCrasherBlockEntity) entity;
    ...
    public BasicPerformanceRockCrasherBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.BASIC_PERFORMANCE_ROCK_CRASHER_BLOCK.get());
    }
