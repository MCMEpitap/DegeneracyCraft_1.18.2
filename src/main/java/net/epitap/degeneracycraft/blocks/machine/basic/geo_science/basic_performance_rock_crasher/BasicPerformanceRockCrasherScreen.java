...
public class BasicPerformanceRockCrasherScreen extends AbstractContainerScreen<BasicPerformanceRockCrasherMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/geo_science/basic_performance_rock_crasher/basic_performance_rock_crasher_gui.png");
