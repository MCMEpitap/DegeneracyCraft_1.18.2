...
public class BasicPerformanceRockCrasherStructure {
    ...
    public static boolean isPowered1(Level level, BlockPos pos, BlockState state, BasicPerformanceRockCrasherBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceRockCrasherBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    private static @NotNull Map<String, Predicate<BlockState>> getBlockConditions() {
        ...
        blockConditions.put("1", blockState -> blockState.is(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ENERGY_INPUT_BUS_BLOCK.get()));
        blockConditions.put("2", blockState -> blockState.is(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ENERGY_OUTPUT_BUS_BLOCK.get()));
        blockConditions.put("3", blockState -> blockState.is(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ITEM_INPUT_PORT_BLOCK.get()));
        blockConditions.put("4", blockState -> blockState.is(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK.get()));
    ...
    private static @NotNull Map<String, Supplier<BlockState>> getHoloBlockSuppliers() {
        ...
        blockSuppliers.put("I", () -> DCBlocks.BASIC_CRASHING_BASE_HOLO_BLOCK.get().defaultBlockState());
        blockSuppliers.put("1", () -> DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ENERGY_INPUT_BUS_HOLO_BLOCK.get().defaultBlockState());
        blockSuppliers.put("2", () -> DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ENERGY_OUTPUT_BUS_HOLO_BLOCK.get().defaultBlockState());
        blockSuppliers.put("3", () -> DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ITEM_INPUT_PORT_HOLO_BLOCK.get().defaultBlockState());
        blockSuppliers.put("4", () -> DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ITEM_OUTPUT_PORT_HOLO_BLOCK.get().defaultBlockState());
