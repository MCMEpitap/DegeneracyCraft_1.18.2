...
public class BasicPerformanceRockCrasherStructure {
    static int minX = -1, maxX = 1;
    static int minY = -1, maxY = 2;
    ...
    public BasicPerformanceRockCrasherStructure() {
    }


    public static boolean isFormed(Level level, BlockPos pos, BlockState state, BasicPerformanceRockCrasherBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceRockCrasherBlock.FACING);
        ...
        blockConditions.put("P", blockState -> blockState.is(DCBlocks.BASIC_PERFORMANCE_ROCK_CRASHER_PORT_BLOCK.get()));
        blockConditions.put("S", blockState -> blockState.is(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_MATERIAL_STORAGE_BLOCK.get()));
        blockConditions.put("B", blockState -> blockState.is(DCBlocks.BASIC_PERFORMANCE_ROCK_CRASHER_BUS_BLOCK.get()));
    ...
    public static boolean isPowered0(Level level, BlockPos pos, BlockState state, BasicPerformanceRockCrasherBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceRockCrasherBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
        ...
        blockConditions.put("B", blockState -> blockState.is(DCBlocks.BASIC_PERFORMANCE_ROCK_CRASHER_BUS_BLOCK.get()));
        blockConditions.put("E", blockState -> blockState.is(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get()));
        blockConditions.put("I", blockState -> blockState.is(DCBlocks.BASIC_CRASHING_BASE_BLOCK.get()));
    ...
    public static void hologram(Level level, BlockPos pos, BlockState state, BasicPerformanceRockCrasherBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceRockCrasherBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
        ...
        blockMapping.put("P", DCBlocks.BASIC_PERFORMANCE_ROCK_CRASHER_PORT_HOLO_BLOCK);
        blockMapping.put("S", DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_MATERIAL_STORAGE_HOLO_BLOCK);
        blockMapping.put("B", DCBlocks.BASIC_PERFORMANCE_ROCK_CRASHER_BUS_HOLO_BLOCK);
    ...
    private static boolean isExpectedBlock(BlockState blockState, String blockKey) {
        return switch (blockKey) {
            ...
            case "P" -> blockState.is(DCBlocks.BASIC_PERFORMANCE_ROCK_CRASHER_PORT_BLOCK.get());
            case "S" -> blockState.is(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_MATERIAL_STORAGE_BLOCK.get());
            case "B" -> blockState.is(DCBlocks.BASIC_PERFORMANCE_ROCK_CRASHER_BUS_BLOCK.get());
            case "E" -> blockState.is(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get());
            case "I" -> blockState.is(DCBlocks.BASIC_CRASHING_BASE_BLOCK.get());
            default -> false;
        };
    }
