...
public class BasicPerformanceSoilPurifierMenu extends AbstractContainerMenu {
    ...
    public BasicPerformanceSoilPurifierMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.BASIC_PERFORMANCE_SOIL_PURIFIER_MENU.get(), id);
        blockEntity = (BasicPerformanceSoilPurifierBlockEntity) entity;
    ...
    public BasicPerformanceSoilPurifierBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.BASIC_PERFORMANCE_SOIL_PURIFIER_BLOCK.get());
    }
