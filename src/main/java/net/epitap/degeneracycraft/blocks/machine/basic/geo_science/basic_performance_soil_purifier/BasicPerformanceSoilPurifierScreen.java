...
public class BasicPerformanceSoilPurifierScreen extends AbstractContainerScreen<BasicPerformanceSoilPurifierMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/geo_science/basic_performance_soil_purifier/basic_performance_soil_purifier_gui.png");
    private EnergyInfoArea energyInfoArea;


    public BasicPerformanceSoilPurifierScreen(BasicPerformanceSoilPurifierMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceSoilPurifierBlockEntity.isHaltDevice(menu.blockEntity)) {
