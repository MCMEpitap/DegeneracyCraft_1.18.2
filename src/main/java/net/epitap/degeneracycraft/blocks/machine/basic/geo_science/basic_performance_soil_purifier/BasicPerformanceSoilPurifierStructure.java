...
public class BasicPerformanceSoilPurifierStructure {
    ...
    private static @NotNull Map<String, Supplier<BlockState>> getHoloBlockSuppliers() {
        ...
        blockSuppliers.put("P", () -> DCBlocks.BASIC_PERFORMANCE_SOIL_PURIFIER_PORT_HOLO_BLOCK.get().defaultBlockState());
        blockSuppliers.put("S", () -> DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_MATERIAL_STORAGE_HOLO_BLOCK.get().defaultBlockState());
        blockSuppliers.put("B", () -> DCBlocks.BASIC_PERFORMANCE_SOIL_PURIFIER_BUS_HOLO_BLOCK.get().defaultBlockState());
        blockSuppliers.put("E", () -> DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_HOLO_BLOCK.get().defaultBlockState());
        blockSuppliers.put("O", () -> DCBlocks.BASIC_EFFICIENCY_PARTICLE_MIXING_CHAMBER_HOLO_BLOCK.get().defaultBlockState());
