...
public class BasicPerformanceSoilPurifierStructure {
    ...
    public static boolean isPowered1(Level level, BlockPos pos, BlockState state, BasicPerformanceSoilPurifierBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceSoilPurifierBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    private static @NotNull Map<String, Supplier<BlockState>> getHoloBlockSuppliers() {
        ...
        blockSuppliers.put("M", () -> DCBlocks.BASIC_EFFICIENCY_PARTICLE_MIXING_CHAMBER_HOLO_BLOCK.get().defaultBlockState());
