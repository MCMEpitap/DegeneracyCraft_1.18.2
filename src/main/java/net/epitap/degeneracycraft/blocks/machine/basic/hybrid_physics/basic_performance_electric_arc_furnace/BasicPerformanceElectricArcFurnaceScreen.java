...
public class BasicPerformanceElectricArcFurnaceScreen extends AbstractContainerScreen<BasicPerformanceElectricArcFurnaceMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/dynamic_physics/basic_performance_electric_arc_furnace/basic_performance_electric_arc_furnace_gui.png");
