...
public class BasicPerformanceElectricArcFurnaceStructure {
    ...
    public BasicPerformanceElectricArcFurnaceStructure() {
    }
    ...
    public static void hologram(Level level, BlockPos pos, BlockState state, BasicPerformanceElectricArcFurnaceBlockEntity blockEntity) {
        ...
        blockMapping.put("I", DCBlocks.BASIC_FLOW_COOLING_SYSTEM_HOLO_BLOCK);
    ...
    private static boolean isExpectedBlock(BlockState blockState, String blockKey) {
        return switch (blockKey) {
            ...
            case "I" -> blockState.is(DCBlocks.BASIC_FLOW_COOLING_SYSTEM_BLOCK.get());
            default -> false;
        };
    }
