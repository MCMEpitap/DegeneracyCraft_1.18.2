...
public class BasicPerformanceElectricArcFurnaceStructure {
    ...
    public static boolean isPowered1(Level level, BlockPos pos, BlockState state, BasicPerformanceElectricArcFurnaceBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicPerformanceElectricArcFurnaceBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    private static @NotNull Map<String, Predicate<BlockState>> getBlockConditions() {
        ...
        blockConditions.put("I", blockState -> blockState.is(DCBlocks.BASIC_FLOW_COOLING_SYSTEM_BLOCK.get()));
    ...
    private static @NotNull Map<String, Supplier<BlockState>> getHoloBlockSuppliers() {
        ...
        blockSuppliers.put("I", () -> DCBlocks.BASIC_FLOW_COOLING_SYSTEM_HOLO_BLOCK.get().defaultBlockState());
