...
public class BasicPerformanceElectricArcFurnaceStructure {
    public static boolean isFormed(BasicPerformanceElectricArcFurnaceBlockEntity blockEntity) {
        return blockEntity.isFormed = blockEntity.formed0 && blockEntity.formed1 && blockEntity.formed2 && blockEntity.formed3;
    }
    ...
    public static boolean isFormed0(Level level, BlockPos pos, BlockState state, BasicPerformanceElectricArcFurnaceBlockEntity blockEntity) {
        ...
        boolean pos0 = level.getBlockState(blockpos.relative(reX, MBPPos.x_1y_1z_2.xPos).above(MBPPos.x_1y_1z_2.yPos).relative(reZ, MBPPos.x_1y_1z_2.zPos))
                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get());
        ...
        boolean pos6 = level.getBlockState(blockpos.relative(reX, MBPPos.x_1y_1z0.xPos).above(MBPPos.x_1y_1z0.yPos).relative(reZ, MBPPos.x_1y_1z0.zPos))
                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_MATERIAL_STORAGE_BLOCK.get());
    ...
    public static boolean isFormed1(Level level, BlockPos pos, BlockState state, BasicPerformanceElectricArcFurnaceBlockEntity blockEntity) {
        ...
        boolean pos5 = level.getBlockState(blockpos.relative(reX, MBPPos.x_1y0z0.xPos).above(MBPPos.x_1y0z0.yPos).relative(reZ, MBPPos.x_1y0z0.zPos))
                .is(DCBlocks.BASIC_PERFORMANCE_ELECTRIC_ARC_FURNACE_PORT_BLOCK.get());
    ...
    public static boolean isFormed2(Level level, BlockPos pos, BlockState state, BasicPerformanceElectricArcFurnaceBlockEntity blockEntity) {
        ...
        boolean pos5 = level.getBlockState(blockpos.relative(reX, MBPPos.x_1y1z0.xPos).above(MBPPos.x_1y1z0.yPos).relative(reZ, MBPPos.x_1y1z0.zPos))
                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get());
    ...
    public static boolean isFormed3(Level level, BlockPos pos, BlockState state, BasicPerformanceElectricArcFurnaceBlockEntity blockEntity) {
        ...
        boolean pos0 = level.getBlockState(blockpos.relative(reX, MBPPos.x_1y2z_2.xPos).above(MBPPos.x_1y2z_2.yPos).relative(reZ, MBPPos.x_1y2z_2.zPos))
                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get());
        boolean pos1 = level.getBlockState(blockpos.relative(reX, MBPPos.x0y2z_2.xPos).above(MBPPos.x0y2z_2.yPos).relative(reZ, MBPPos.x0y2z_2.zPos))
                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get());
        boolean pos2 = level.getBlockState(blockpos.relative(reX, MBPPos.x1y2z_2.xPos).above(MBPPos.x1y2z_2.yPos).relative(reZ, MBPPos.x1y2z_2.zPos))
                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get());
        boolean pos3 = level.getBlockState(blockpos.relative(reX, MBPPos.x_1y2z_1.xPos).above(MBPPos.x_1y2z_1.yPos).relative(reZ, MBPPos.x_1y2z_1.zPos))
                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get());
        boolean pos4 = level.getBlockState(blockpos.relative(reX, MBPPos.x0y2z_1.xPos).above(MBPPos.x0y2z_1.yPos).relative(reZ, MBPPos.x0y2z_1.zPos))
                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get());
        boolean pos5 = level.getBlockState(blockpos.relative(reX, MBPPos.x1y2z_1.xPos).above(MBPPos.x1y2z_1.yPos).relative(reZ, MBPPos.x1y2z_1.zPos))
                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get());
        boolean pos6 = level.getBlockState(blockpos.relative(reX, MBPPos.x_1y2z0.xPos).above(MBPPos.x_1y2z0.yPos).relative(reZ, MBPPos.x_1y2z0.zPos))
                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get());
        boolean pos7 = level.getBlockState(blockpos.relative(reX, MBPPos.x0y2z0.xPos).above(MBPPos.x0y2z0.yPos).relative(reZ, MBPPos.x0y2z0.zPos))
                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get());
        boolean pos8 = level.getBlockState(blockpos.relative(reX, MBPPos.x1y2z0.xPos).above(MBPPos.x1y2z0.yPos).relative(reZ, MBPPos.x1y2z0.zPos))
                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get());

        return blockEntity.formed3 = pos0 && pos1 && pos2 && pos3 && pos4 && pos5 && pos6 && pos7 && pos8;
    }
    ...
    public static boolean powered0_1(Level level, BlockPos pos, BlockState state, BasicPerformanceElectricArcFurnaceBlockEntity blockEntity) {
        ...
        boolean pos1 = level.getBlockState(blockpos.relative(reX, MBPPos.x0y1z_1.xPos).above(MBPPos.x0y1z_1.yPos).relative(reZ, MBPPos.x0y1z_1.zPos))
                .is(DCBlocks.BASIC_FLOW_COOLING_SYSTEM_BLOCK.get());

        return blockEntity.powered0_1 = pos0 && pos1;
    }
        ...
        if (blockEntity.itemHandler.getStackInSlot(3).is(DCItems.MULTIBLOCK_STRUCTURE_HOLOGRAM_VISUALIZER.get())
            ...
            if (level.getBlockState(blockpos.relative(reX, MBPPos.x_1y_1z_2.xPos).above(MBPPos.x_1y_1z_2.yPos).relative(reZ, MBPPos.x_1y_1z_2.zPos)).isAir()) {
                level.setBlock(blockpos.relative(reX, MBPPos.x_1y_1z_2.xPos).above(MBPPos.x_1y_1z_2.yPos).relative(reZ, MBPPos.x_1y_1z_2.zPos),
                        DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get().defaultBlockState(), 1);
            }
            ...
            if (level.getBlockState(blockpos.relative(reX, MBPPos.x_1y_1z0.xPos).above(MBPPos.x_1y_1z0.yPos).relative(reZ, MBPPos.x_1y_1z0.zPos)).isAir()) {
                level.setBlock(blockpos.relative(reX, MBPPos.x_1y_1z0.xPos).above(MBPPos.x_1y_1z0.yPos).relative(reZ, MBPPos.x_1y_1z0.zPos),
                        DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_MATERIAL_STORAGE_HOLO_BLOCK.get().defaultBlockState(), 1);
            }
            ...
            if (blockEntity.formed0) {
                ...
                if (level.getBlockState(blockpos.relative(reX, MBPPos.x_1y0z0.xPos).above(MBPPos.x_1y0z0.yPos).relative(reZ, MBPPos.x_1y0z0.zPos)).isAir()) {
                    level.setBlock(blockpos.relative(reX, MBPPos.x_1y0z0.xPos).above(MBPPos.x_1y0z0.yPos).relative(reZ, MBPPos.x_1y0z0.zPos),
                            DCBlocks.BASIC_PERFORMANCE_ELECTRIC_ARC_FURNACE_PORT_HOLO_BLOCK.get().defaultBlockState(), 1);
                }
                ...
                if (blockEntity.formed1) {
                    ...
                    if (level.getBlockState(blockpos.relative(reX, MBPPos.x_1y1z0.xPos).above(MBPPos.x_1y1z0.yPos).relative(reZ, MBPPos.x_1y1z0.zPos)).isAir()) {
                        level.setBlock(blockpos.relative(reX, MBPPos.x_1y1z0.xPos).above(MBPPos.x_1y1z0.yPos).relative(reZ, MBPPos.x_1y1z0.zPos),
                                DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_ENERGY_STORAGE_HOLO_BLOCK.get().defaultBlockState(), 1);
                    }
                    if (level.getBlockState(blockpos.relative(reX, MBPPos.x0y1z0.xPos).above(MBPPos.x0y1z0.yPos).relative(reZ, MBPPos.x0y1z0.zPos)).isAir()) {
                        level.setBlock(blockpos.relative(reX, MBPPos.x0y1z0.xPos).above(MBPPos.x0y1z0.yPos).relative(reZ, MBPPos.x0y1z0.zPos),
                                DCBlocks.BASIC_PERFORMANCE_ELECTRIC_ARC_FURNACE_BUS_HOLO_BLOCK.get().defaultBlockState(), 1);
                    }
                    ...
                    if (blockEntity.formed2) {
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x_1y2z_2.xPos).above(MBPPos.x_1y2z_2.yPos).relative(reZ, MBPPos.x_1y2z_2.zPos)).isAir()) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x_1y2z_2.xPos).above(MBPPos.x_1y2z_2.yPos).relative(reZ, MBPPos.x_1y2z_2.zPos),
                                    DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get().defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x0y2z_2.xPos).above(MBPPos.x0y2z_2.yPos).relative(reZ, MBPPos.x0y2z_2.zPos)).isAir()) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x0y2z_2.xPos).above(MBPPos.x0y2z_2.yPos).relative(reZ, MBPPos.x0y2z_2.zPos),
                                    DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get().defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x1y2z_2.xPos).above(MBPPos.x1y2z_2.yPos).relative(reZ, MBPPos.x1y2z_2.zPos)).isAir()) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x1y2z_2.xPos).above(MBPPos.x1y2z_2.yPos).relative(reZ, MBPPos.x1y2z_2.zPos),
                                    DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get().defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x_1y2z_1.xPos).above(MBPPos.x_1y2z_1.yPos).relative(reZ, MBPPos.x_1y2z_1.zPos)).isAir()) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x_1y2z_1.xPos).above(MBPPos.x_1y2z_1.yPos).relative(reZ, MBPPos.x_1y2z_1.zPos),
                                    DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get().defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x0y2z_1.xPos).above(MBPPos.x0y2z_1.yPos).relative(reZ, MBPPos.x0y2z_1.zPos)).isAir()) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x0y2z_1.xPos).above(MBPPos.x0y2z_1.yPos).relative(reZ, MBPPos.x0y2z_1.zPos),
                                    DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get().defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x1y2z_1.xPos).above(MBPPos.x1y2z_1.yPos).relative(reZ, MBPPos.x1y2z_1.zPos)).isAir()) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x1y2z_1.xPos).above(MBPPos.x1y2z_1.yPos).relative(reZ, MBPPos.x1y2z_1.zPos),
                                    DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get().defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x_1y2z0.xPos).above(MBPPos.x_1y2z0.yPos).relative(reZ, MBPPos.x_1y2z0.zPos)).isAir()) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x_1y2z0.xPos).above(MBPPos.x_1y2z0.yPos).relative(reZ, MBPPos.x_1y2z0.zPos),
                                    DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get().defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x0y2z0.xPos).above(MBPPos.x0y2z0.yPos).relative(reZ, MBPPos.x0y2z0.zPos)).isAir()) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x0y2z0.xPos).above(MBPPos.x0y2z0.yPos).relative(reZ, MBPPos.x0y2z0.zPos),
                                    DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get().defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x1y2z0.xPos).above(MBPPos.x1y2z0.yPos).relative(reZ, MBPPos.x1y2z0.zPos)).isAir()) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x1y2z0.xPos).above(MBPPos.x1y2z0.yPos).relative(reZ, MBPPos.x1y2z0.zPos),
                                    DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get().defaultBlockState(), 1);
                        }
                    } else {
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x_1y2z_2.xPos).above(MBPPos.x_1y2z_2.yPos).relative(reZ, MBPPos.x_1y2z_2.zPos))
                                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get())) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x_1y2z_2.xPos).above(MBPPos.x_1y2z_2.yPos).relative(reZ, MBPPos.x_1y2z_2.zPos), Blocks.AIR.defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x0y2z_2.xPos).above(MBPPos.x0y2z_2.yPos).relative(reZ, MBPPos.x0y2z_2.zPos))
                                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get())) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x0y2z_2.xPos).above(MBPPos.x0y2z_2.yPos).relative(reZ, MBPPos.x0y2z_2.zPos), Blocks.AIR.defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x1y2z_2.xPos).above(MBPPos.x1y2z_2.yPos).relative(reZ, MBPPos.x1y2z_2.zPos))
                                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get())) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x1y2z_2.xPos).above(MBPPos.x1y2z_2.yPos).relative(reZ, MBPPos.x1y2z_2.zPos), Blocks.AIR.defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x_1y2z_1.xPos).above(MBPPos.x_1y2z_1.yPos).relative(reZ, MBPPos.x_1y2z_1.zPos))
                                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get())) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x_1y2z_1.xPos).above(MBPPos.x_1y2z_1.yPos).relative(reZ, MBPPos.x_1y2z_1.zPos), Blocks.AIR.defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x0y2z_1.xPos).above(MBPPos.x0y2z_1.yPos).relative(reZ, MBPPos.x0y2z_1.zPos))
                                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get())) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x0y2z_1.xPos).above(MBPPos.x0y2z_1.yPos).relative(reZ, MBPPos.x0y2z_1.zPos), Blocks.AIR.defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x1y2z_1.xPos).above(MBPPos.x1y2z_1.yPos).relative(reZ, MBPPos.x1y2z_1.zPos))
                                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get())) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x1y2z_1.xPos).above(MBPPos.x1y2z_1.yPos).relative(reZ, MBPPos.x1y2z_1.zPos), Blocks.AIR.defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x_1y2z0.xPos).above(MBPPos.x_1y2z0.yPos).relative(reZ, MBPPos.x_1y2z0.zPos))
                                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get())) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x_1y2z0.xPos).above(MBPPos.x_1y2z0.yPos).relative(reZ, MBPPos.x_1y2z0.zPos), Blocks.AIR.defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x0y2z0.xPos).above(MBPPos.x0y2z0.yPos).relative(reZ, MBPPos.x0y2z0.zPos))
                                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get())) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x0y2z0.xPos).above(MBPPos.x0y2z0.yPos).relative(reZ, MBPPos.x0y2z0.zPos), Blocks.AIR.defaultBlockState(), 1);
                        }
                        if (level.getBlockState(blockpos.relative(reX, MBPPos.x1y2z0.xPos).above(MBPPos.x1y2z0.yPos).relative(reZ, MBPPos.x1y2z0.zPos))
                                .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK.get())) {
                            level.setBlock(blockpos.relative(reX, MBPPos.x1y2z0.xPos).above(MBPPos.x1y2z0.yPos).relative(reZ, MBPPos.x1y2z0.zPos), Blocks.AIR.defaultBlockState(), 1);
                        }
                    }
                } else {
                    ...
                    if (level.getBlockState(blockpos.relative(reX, MBPPos.x_1y1z0.xPos).above(MBPPos.x_1y1z0.yPos).relative(reZ, MBPPos.x_1y1z0.zPos))
                            .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_ENERGY_STORAGE_HOLO_BLOCK.get())) {
                    ...
                    if (level.getBlockState(blockpos.relative(reX, MBPPos.x0y1z0.xPos).above(MBPPos.x0y1z0.yPos).relative(reZ, MBPPos.x0y1z0.zPos))
                            .is(DCBlocks.BASIC_PERFORMANCE_ELECTRIC_ARC_FURNACE_BUS_HOLO_BLOCK.get())) {
                ...
                if (level.getBlockState(blockpos.relative(reX, MBPPos.x_1y0z0.xPos).above(MBPPos.x_1y0z0.yPos).relative(reZ, MBPPos.x_1y0z0.zPos))
                        .is(DCBlocks.BASIC_PERFORMANCE_ELECTRIC_ARC_FURNACE_PORT_HOLO_BLOCK.get())) {
            ...
            if (level.getBlockState(blockpos.relative(reX, MBPPos.x_1y_1z0.xPos).above(MBPPos.x_1y_1z0.yPos).relative(reZ, MBPPos.x_1y_1z0.zPos))
                    .is(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_MATERIAL_STORAGE_HOLO_BLOCK.get())) {
