...
public class BasicPerformanceFormingMachineMenu extends AbstractContainerMenu {
    ...
    public final BasicPerformanceFormingMachineBlockEntity blockEntity;
    ...
    public BasicPerformanceFormingMachineMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.BASIC_PERFORMANCE_FORMING_MACHINE_MENU.get(), id);
        blockEntity = (BasicPerformanceFormingMachineBlockEntity) entity;
    ...
    public BasicPerformanceFormingMachineBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.BASIC_PERFORMANCE_FORMING_MACHINE_BLOCK.get());
    }
