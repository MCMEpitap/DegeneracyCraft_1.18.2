...
public class BasicPerformanceFormingMachineScreen extends AbstractContainerScreen<BasicPerformanceFormingMachineMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/hybrid_physics/basic_performance_forming_machine/basic_performance_forming_machine_gui.png");
    private EnergyInfoArea energyInfoArea;


    public BasicPerformanceFormingMachineScreen(BasicPerformanceFormingMachineMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceFormingMachineBlockEntity.isHaltDevice(menu.blockEntity)) {
