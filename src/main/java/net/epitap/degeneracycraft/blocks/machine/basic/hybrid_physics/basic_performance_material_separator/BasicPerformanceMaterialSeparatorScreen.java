...
public class BasicPerformanceMaterialSeparatorScreen extends AbstractContainerScreen<BasicPerformanceMaterialSeparatorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/hybrid_physics/basic_performance_material_separator/basic_performance_material_separator_gui.png");
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceMaterialSeparatorBlockEntity.isHaltDevice(menu.blockEntity)) {
