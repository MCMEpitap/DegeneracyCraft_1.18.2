...
public class BasicTechnologyImitationMagicEngraverScreen extends AbstractContainerScreen<BasicTechnologyImitationMagicEngraverMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/imitation_magic_engineering/basic_technology_imitation_magic_engraver/basic_technology_imitation_magic_engraver_gui.png");
    private EnergyInfoArea energyInfoArea;


    public BasicTechnologyImitationMagicEngraverScreen(BasicTechnologyImitationMagicEngraverMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicTechnologyImitationMagicEngraverBlockEntity.isHaltDevice(menu.blockEntity)) {
