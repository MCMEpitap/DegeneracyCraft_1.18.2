...
public class BasicTechnologySuspectedMagicCondenserMenu extends AbstractContainerMenu {
    ...
    public BasicTechnologySuspectedMagicCondenserMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.BASIC_TECHNOLOGY_SUSPECTED_MAGIC_CONDENSER_MENU.get(), id);
        blockEntity = (BasicTechnologySuspectedMagicCondenserBlockEntity) entity;
    ...
    public BasicTechnologySuspectedMagicCondenserBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.BASIC_TECHNOLOGY_SUSPECTED_MAGIC_CONDENSER_BLOCK.get());
    }
