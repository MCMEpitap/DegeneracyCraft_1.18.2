...
public class BasicTechnologySuspectedMagicCondenserScreen extends AbstractContainerScreen<BasicTechnologySuspectedMagicCondenserMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/imitation_magic_engineering/basic_technology_suspected_magic_condenser/basic_technology_suspected_magic_condenser_gui.png");
    private EnergyInfoArea energyInfoArea;


    public BasicTechnologySuspectedMagicCondenserScreen(BasicTechnologySuspectedMagicCondenserMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicTechnologySuspectedMagicCondenserBlockEntity.isHaltDevice(menu.blockEntity)) {
