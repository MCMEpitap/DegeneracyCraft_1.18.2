...
public class BasicTechnologySuspectedMagicCondenserStructure {
    ...
    private static @NotNull Map<String, Supplier<BlockState>> getHoloBlockSuppliers() {
        ...
        blockSuppliers.put("P", () -> DCBlocks.BASIC_TECHNOLOGY_SUSPECTED_MAGIC_CONDENSER_PORT_HOLO_BLOCK.get().defaultBlockState());
        ...
        blockSuppliers.put("B", () -> DCBlocks.BASIC_TECHNOLOGY_SUSPECTED_MAGIC_CONDENSER_BUS_HOLO_BLOCK.get().defaultBlockState());
