...
public class BasicTechnologySuspectedMagicCondenserStructure {
    ...
    public static boolean isPowered1(Level level, BlockPos pos, BlockState state, BasicTechnologySuspectedMagicCondenserBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologySuspectedMagicCondenserBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    private static @NotNull Map<String, Supplier<BlockState>> getHoloBlockSuppliers() {
        ...
        blockSuppliers.put("C", () -> DCBlocks.BASIC_EFFICIENCY_SEALED_EXTRACTION_CASE_HOLO_BLOCK.get().defaultBlockState());
