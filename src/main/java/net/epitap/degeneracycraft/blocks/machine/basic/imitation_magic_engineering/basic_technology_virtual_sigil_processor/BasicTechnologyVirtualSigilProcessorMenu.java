...
public class BasicTechnologyVirtualSigilProcessorMenu extends AbstractContainerMenu {
    ...
    public BasicTechnologyVirtualSigilProcessorMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_MENU.get(), id);
        blockEntity = (BasicTechnologyVirtualSigilProcessorBlockEntity) entity;
    ...
    public BasicTechnologyVirtualSigilProcessorBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_BLOCK.get());
    }
