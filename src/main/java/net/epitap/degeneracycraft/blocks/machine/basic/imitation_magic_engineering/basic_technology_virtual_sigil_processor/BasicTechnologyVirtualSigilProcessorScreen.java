...
public class BasicTechnologyVirtualSigilProcessorScreen extends AbstractContainerScreen<BasicTechnologyVirtualSigilProcessorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/imitation_magic_engineering/basic_technology_virtual_sigil_processor/basic_technology_virtual_sigil_processor_gui.png");
    private EnergyInfoArea energyInfoArea;


    public BasicTechnologyVirtualSigilProcessorScreen(BasicTechnologyVirtualSigilProcessorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicTechnologyVirtualSigilProcessorBlockEntity.isHaltDevice(menu.blockEntity)) {
