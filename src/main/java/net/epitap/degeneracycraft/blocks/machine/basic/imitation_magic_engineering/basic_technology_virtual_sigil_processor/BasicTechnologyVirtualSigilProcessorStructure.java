...
public class BasicTechnologyVirtualSigilProcessorStructure {
    ...
    public BasicTechnologyVirtualSigilProcessorStructure() {
    }


    public static boolean isFormed(Level level, BlockPos pos, BlockState state, BasicTechnologyVirtualSigilProcessorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyVirtualSigilProcessorBlock.FACING);
        ...
        blockConditions.put("P", blockState -> blockState.is(DCBlocks.BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_PORT_BLOCK.get()));
        ...
        blockConditions.put("B", blockState -> blockState.is(DCBlocks.BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_BUS_BLOCK.get()));
    ...
    public static boolean isPowered0(Level level, BlockPos pos, BlockState state, BasicTechnologyVirtualSigilProcessorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyVirtualSigilProcessorBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
        ...
        blockConditions.put("B", blockState -> blockState.is(DCBlocks.BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_BUS_BLOCK.get()));
        blockConditions.put("E", blockState -> blockState.is(DCBlocks.BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get()));
        blockConditions.put("T", blockState -> blockState.is(DCBlocks.BASIC_SPEED_PATTERN_TRANSFER_SYSTEM_BLOCK.get()));
    ...
    public static void hologram(Level level, BlockPos pos, BlockState state, BasicTechnologyVirtualSigilProcessorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyVirtualSigilProcessorBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
        ...
        blockMapping.put("P", DCBlocks.BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_PORT_HOLO_BLOCK);
        blockMapping.put("S", DCBlocks.BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_MATERIAL_STORAGE_HOLO_BLOCK);
        blockMapping.put("B", DCBlocks.BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_BUS_HOLO_BLOCK);
        blockMapping.put("E", DCBlocks.BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_ENERGY_STORAGE_HOLO_BLOCK);
        blockMapping.put("T", DCBlocks.BASIC_SPEED_PATTERN_TRANSFER_SYSTEM_HOLO_BLOCK);
    ...
    private static boolean isExpectedBlock(BlockState blockState, String blockKey) {
        return switch (blockKey) {
            ...
            case "P" -> blockState.is(DCBlocks.BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_PORT_BLOCK.get());
            case "S" -> blockState.is(DCBlocks.BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_MATERIAL_STORAGE_BLOCK.get());
            case "B" -> blockState.is(DCBlocks.BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_BUS_BLOCK.get());
            case "E" -> blockState.is(DCBlocks.BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get());
            case "T" -> blockState.is(DCBlocks.BASIC_SPEED_PATTERN_TRANSFER_SYSTEM_BLOCK.get());
            default -> false;
        };
    }
