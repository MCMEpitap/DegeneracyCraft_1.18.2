...
public class BasicTechnologyVirtualSigilProcessorStructure {
    ...
    public static boolean isPowered1(Level level, BlockPos pos, BlockState state, BasicTechnologyVirtualSigilProcessorBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyVirtualSigilProcessorBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    private static @NotNull Map<String, Supplier<BlockState>> getHoloBlockSuppliers() {
        ...
        blockSuppliers.put("T", () -> DCBlocks.BASIC_SPEED_PATTERN_TRANSFER_SYSTEM_HOLO_BLOCK.get().defaultBlockState());
