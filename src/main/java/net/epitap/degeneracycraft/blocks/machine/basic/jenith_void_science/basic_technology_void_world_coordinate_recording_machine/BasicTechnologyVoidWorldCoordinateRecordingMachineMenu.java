...
public class BasicTechnologyVoidWorldCoordinateRecordingMachineMenu extends AbstractContainerMenu {
    ...
    public BasicTechnologyVoidWorldCoordinateRecordingMachineMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.BASIC_TECHNOLOGY_VOID_WORLD_COORDINATE_RECORDING_MACHINE_MENU.get(), id);
        blockEntity = (BasicTechnologyVoidWorldCoordinateRecordingMachineBlockEntity) entity;
    ...
    public BasicTechnologyVoidWorldCoordinateRecordingMachineBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.BASIC_TECHNOLOGY_VOID_WORLD_COORDINATE_RECORDING_MACHINE_BLOCK.get());
    }
