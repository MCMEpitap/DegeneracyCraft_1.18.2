...
public class BasicTechnologyVoidWorldCoordinateRecordingMachineScreen extends AbstractContainerScreen<BasicTechnologyVoidWorldCoordinateRecordingMachineMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/jenith_void_science/basic_technology_void_world_coordinate_recording_machine/basic_technology_void_world_coordinate_recording_machine_gui.png");
    private EnergyInfoArea energyInfoArea;


    public BasicTechnologyVoidWorldCoordinateRecordingMachineScreen(BasicTechnologyVoidWorldCoordinateRecordingMachineMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicTechnologyVoidWorldCoordinateRecordingMachineBlockEntity.isHaltDevice(menu.blockEntity)) {
