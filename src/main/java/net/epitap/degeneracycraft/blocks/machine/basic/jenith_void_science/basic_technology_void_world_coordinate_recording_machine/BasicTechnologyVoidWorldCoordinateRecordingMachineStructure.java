...
public class BasicTechnologyVoidWorldCoordinateRecordingMachineStructure {
    ...
    public static boolean isPowered1(Level level, BlockPos pos, BlockState state, BasicTechnologyVoidWorldCoordinateRecordingMachineBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyVoidWorldCoordinateRecordingMachineBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    private static @NotNull Map<String, Supplier<BlockState>> getHoloBlockSuppliers() {
        ...
        blockSuppliers.put("S", () -> DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_MATERIAL_STORAGE_HOLO_BLOCK.get().defaultBlockState());
