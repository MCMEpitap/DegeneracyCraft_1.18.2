...
public class BasicTechnologyVoidWorldCoordinateRecordingMachineStructure {
    static int minX = -2, maxX = 2;
    static int minY = -1, maxY = 3;
    static int minZ = -4, maxZ = 0;
    ...
    public BasicTechnologyVoidWorldCoordinateRecordingMachineStructure() {
    }


    public static boolean isFormed(Level level, BlockPos pos, BlockState state, BasicTechnologyVoidWorldCoordinateRecordingMachineBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyVoidWorldCoordinateRecordingMachineBlock.FACING);
        ...
        blockConditions.put("S", blockState -> blockState.is(DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_MATERIAL_STORAGE_BLOCK.get()));
    ...
    public static boolean isPowered0(Level level, BlockPos pos, BlockState state, BasicTechnologyVoidWorldCoordinateRecordingMachineBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyVoidWorldCoordinateRecordingMachineBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    public static void hologram(Level level, BlockPos pos, BlockState state, BasicTechnologyVoidWorldCoordinateRecordingMachineBlockEntity blockEntity) {
        Direction facing = state.getValue(BasicTechnologyVoidWorldCoordinateRecordingMachineBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
        ...
        blockMapping.put("F", DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_STRUCTURE_FRAME_HOLO_BLOCK);
        blockMapping.put("G", DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_STRUCTURE_GLASS_HOLO_BLOCK);
        blockMapping.put("P", DCBlocks.BASIC_TECHNOLOGY_VOID_WORLD_COORDINATE_RECORDING_MACHINE_PORT_HOLO_BLOCK);
        blockMapping.put("S", DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_MATERIAL_STORAGE_HOLO_BLOCK);
        blockMapping.put("B", DCBlocks.BASIC_TECHNOLOGY_VOID_WORLD_COORDINATE_RECORDING_MACHINE_BUS_HOLO_BLOCK);
        blockMapping.put("E", DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_HOLO_BLOCK);
        blockMapping.put("V", DCBlocks.BASIC_EFFICIENCY_VOID_INTERFERENCE_FLAME_HOLO_BLOCK);
        ...
        boolean visualizer0 = blockEntity.itemHandler.getStackInSlot(10).is(DCItems.MULTIBLOCK_STRUCTURE_HOLOGRAM_VISUALIZER.get());
        boolean visualizer1 = blockEntity.itemHandler.getStackInSlot(10).is(DCItems.BASIC_TECHNOLOGY_MULTIBLOCK_STRUCTURE_HOLOGRAM_VISUALIZER.get());
    ...
    private static boolean isExpectedBlock(BlockState blockState, String blockKey) {
        return switch (blockKey) {
            case "F" -> blockState.is(DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get());
            case "G" -> blockState.is(DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get());
            case "P" -> blockState.is(DCBlocks.BASIC_TECHNOLOGY_VOID_WORLD_COORDINATE_RECORDING_MACHINE_PORT_BLOCK.get());
            case "S" -> blockState.is(DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_MATERIAL_STORAGE_BLOCK.get());
            case "B" -> blockState.is(DCBlocks.BASIC_TECHNOLOGY_VOID_WORLD_COORDINATE_RECORDING_MACHINE_BUS_BLOCK.get());
            case "E" -> blockState.is(DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get());
            case "V" -> blockState.is(DCBlocks.BASIC_EFFICIENCY_VOID_INTERFERENCE_FLAME_BLOCK.get());
            default -> false;
        };
    }
