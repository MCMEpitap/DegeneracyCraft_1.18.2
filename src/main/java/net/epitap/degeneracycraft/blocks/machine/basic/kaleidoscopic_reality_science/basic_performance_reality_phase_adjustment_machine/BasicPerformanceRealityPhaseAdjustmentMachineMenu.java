...
public class BasicPerformanceRealityPhaseAdjustmentMachineMenu extends AbstractContainerMenu {
    ...
    public BasicPerformanceRealityPhaseAdjustmentMachineMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.BASIC_PERFORMANCE_REALITY_PHASE_ADJUSTMENT_MACHINE_MENU.get(), id);
        blockEntity = (BasicPerformanceRealityPhaseAdjustmentMachineBlockEntity) entity;
    ...
    public BasicPerformanceRealityPhaseAdjustmentMachineBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.BASIC_PERFORMANCE_REALITY_PHASE_ADJUSTMENT_MACHINE_BLOCK.get());
    }
