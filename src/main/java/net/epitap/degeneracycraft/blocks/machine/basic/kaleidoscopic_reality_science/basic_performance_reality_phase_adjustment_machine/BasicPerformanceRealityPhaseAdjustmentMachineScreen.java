...
public class BasicPerformanceRealityPhaseAdjustmentMachineScreen extends AbstractContainerScreen<BasicPerformanceRealityPhaseAdjustmentMachineMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/kaleidoscopic_reality_science/basic_performance_reality_phase_adjustment_machine/basic_performance_reality_phase_adjustment_machine_gui.png");
    private EnergyInfoArea energyInfoArea;


    public BasicPerformanceRealityPhaseAdjustmentMachineScreen(BasicPerformanceRealityPhaseAdjustmentMachineMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (BasicPerformanceRealityPhaseAdjustmentMachineBlockEntity.isHaltDevice(menu.blockEntity)) {
