...
public class DCScreenBase<T extends AbstractContainerMenu> extends AbstractContainerScreen<T> {
    public static final int FONT_COLOR = 4210752;

    protected ResourceLocation texture;
    protected List<HoverArea> hoverAreas;

    public DCScreenBase(ResourceLocation texture, T container, Inventory playerInventory, Component title) {
