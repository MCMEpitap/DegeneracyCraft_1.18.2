...
public class BasicStrengthAstronomyMultiblockEnergyOutputBusScreen extends AbstractContainerScreen<BasicStrengthAstronomyMultiblockEnergyOutputBusMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/multiblock/basic/astronomy/basic_strength_astronomy_multiblock_energy_output_bus/basic_strength_astronomy_multiblock_energy_output_bus_gui.png");
    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthAstronomyMultiblockEnergyOutputBusScreen(BasicStrengthAstronomyMultiblockEnergyOutputBusMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
