...
public class BasicStrengthBiologyMultiblockEnergyStorageScreen extends AbstractContainerScreen<BasicStrengthBiologyMultiblockEnergyStorageMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/multiblock/basic/biology/basic_strength_biology_multiblock_energy_storage/basic_strength_biology_multiblock_energy_storage_gui.png");
    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthBiologyMultiblockEnergyStorageScreen(BasicStrengthBiologyMultiblockEnergyStorageMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
