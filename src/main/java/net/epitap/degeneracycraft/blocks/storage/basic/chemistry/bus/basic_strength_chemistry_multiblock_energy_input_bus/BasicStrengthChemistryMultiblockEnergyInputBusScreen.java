...
public class BasicStrengthChemistryMultiblockEnergyInputBusScreen extends AbstractContainerScreen<BasicStrengthChemistryMultiblockEnergyInputBusMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/multiblock/basic/chemistry/basic_strength_chemistry_multiblock_energy_input_bus/basic_strength_chemistry_multiblock_energy_input_bus_gui.png");
    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthChemistryMultiblockEnergyInputBusScreen(BasicStrengthChemistryMultiblockEnergyInputBusMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
