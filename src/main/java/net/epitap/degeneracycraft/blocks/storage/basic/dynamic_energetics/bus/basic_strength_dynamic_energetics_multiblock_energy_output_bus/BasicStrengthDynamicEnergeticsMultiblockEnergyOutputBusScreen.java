...
public class BasicStrengthDynamicEnergeticsMultiblockEnergyOutputBusScreen extends AbstractContainerScreen<BasicStrengthDynamicEnergeticsMultiblockEnergyOutputBusMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/multiblock/basic/dynamic_energetics/basic_strength_dynamic_energetics_multiblock_energy_output_bus/basic_strength_dynamic_energetics_multiblock_energy_output_bus_gui.png");
    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthDynamicEnergeticsMultiblockEnergyOutputBusScreen(BasicStrengthDynamicEnergeticsMultiblockEnergyOutputBusMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
