...
public class BasicStrengthMultiblockEnergyStorageMenu extends AbstractContainerMenu {
    ...
    public final BasicStrengthMultiblockEnergyStorageBlockEntity blockEntity;
    public final Level level;
    public final ContainerData data;

    public BasicStrengthMultiblockEnergyStorageMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(0));
    }

    public BasicStrengthMultiblockEnergyStorageMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.BASIC_STRENGTH_MULTIBLOCK_ENERGY_STORAGE_BLOCK_MENU.get(), id);
        blockEntity = (BasicStrengthMultiblockEnergyStorageBlockEntity) entity;
...
//            }
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.BASIC_STRENGTH_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get());
    }
