...
public class BasicStrengthFormalScienceMultiblockEnergyStorageScreen extends AbstractContainerScreen<BasicStrengthFormalScienceMultiblockEnergyStorageMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/multiblock/basic/formal_science/basic_strength_formal_science_multiblock_energy_storage/basic_strength_formal_science_multiblock_energy_storage_gui.png");
    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthFormalScienceMultiblockEnergyStorageScreen(BasicStrengthFormalScienceMultiblockEnergyStorageMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
