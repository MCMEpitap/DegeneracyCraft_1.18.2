...
public class BasicStrengthGeoScienceMultiblockEnergyStorageMenu extends AbstractContainerMenu {
    ...
    public final BasicStrengthGeoScienceMultiblockEnergyStorageBlockEntity blockEntity;
    ...
    public BasicStrengthGeoScienceMultiblockEnergyStorageMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_MENU.get(), id);
        blockEntity = (BasicStrengthGeoScienceMultiblockEnergyStorageBlockEntity) entity;
    ...
    public BasicStrengthGeoScienceMultiblockEnergyStorageBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get());
    }
