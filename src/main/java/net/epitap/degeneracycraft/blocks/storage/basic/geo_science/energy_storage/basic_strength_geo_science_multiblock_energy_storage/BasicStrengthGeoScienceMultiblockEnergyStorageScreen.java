...
public class BasicStrengthGeoScienceMultiblockEnergyStorageScreen extends AbstractContainerScreen<BasicStrengthGeoScienceMultiblockEnergyStorageMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/multiblock/basic/geo_science/basic_strength_geo_science_multiblock_energy_storage/basic_strength_geo_science_multiblock_energy_storage_gui.png");
    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthGeoScienceMultiblockEnergyStorageScreen(BasicStrengthGeoScienceMultiblockEnergyStorageMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
