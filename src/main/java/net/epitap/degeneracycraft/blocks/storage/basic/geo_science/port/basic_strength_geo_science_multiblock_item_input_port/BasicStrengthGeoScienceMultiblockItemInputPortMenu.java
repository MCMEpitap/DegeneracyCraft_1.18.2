...
public class BasicStrengthGeoScienceMultiblockItemInputPortMenu extends AbstractContainerMenu {
    ...
    public final BasicStrengthGeoScienceMultiblockItemInputPortBlockEntity blockEntity;
    public final Level level;
    public final ContainerData data;

    public BasicStrengthGeoScienceMultiblockItemInputPortMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public BasicStrengthGeoScienceMultiblockItemInputPortBlockEntity getBlockEntity() {
