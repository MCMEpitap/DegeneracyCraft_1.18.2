...
public class BasicStrengthHybridPhysicsMultiblockEnergyOutputBusScreen extends AbstractContainerScreen<BasicStrengthHybridPhysicsMultiblockEnergyOutputBusMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/multiblock/basic/hybrid_physics/basic_strength_hybrid_physics_multiblock_energy_output_bus/basic_strength_hybrid_physics_multiblock_energy_output_bus_gui.png");
    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthHybridPhysicsMultiblockEnergyOutputBusScreen(BasicStrengthHybridPhysicsMultiblockEnergyOutputBusMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
