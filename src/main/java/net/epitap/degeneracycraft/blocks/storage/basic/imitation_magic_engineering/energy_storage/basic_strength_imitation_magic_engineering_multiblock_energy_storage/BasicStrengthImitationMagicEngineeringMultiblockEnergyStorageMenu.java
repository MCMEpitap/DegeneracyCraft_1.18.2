...
public class BasicStrengthImitationMagicEngineeringMultiblockEnergyStorageMenu extends AbstractContainerMenu {
    ...
    public final BasicStrengthImitationMagicEngineeringMultiblockEnergyStorageBlockEntity blockEntity;
    ...
    public BasicStrengthImitationMagicEngineeringMultiblockEnergyStorageMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_ENERGY_STORAGE_MENU.get(), id);
        blockEntity = (BasicStrengthImitationMagicEngineeringMultiblockEnergyStorageBlockEntity) entity;
    ...
    public BasicStrengthImitationMagicEngineeringMultiblockEnergyStorageBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get());
    }
