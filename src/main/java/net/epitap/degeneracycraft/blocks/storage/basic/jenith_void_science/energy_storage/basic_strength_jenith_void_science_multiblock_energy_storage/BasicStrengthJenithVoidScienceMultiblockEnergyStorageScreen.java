...
public class BasicStrengthJenithVoidScienceMultiblockEnergyStorageScreen extends AbstractContainerScreen<BasicStrengthJenithVoidScienceMultiblockEnergyStorageMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/multiblock/basic/jenith_void_science/basic_strength_jenith_void_science_multiblock_energy_storage/basic_strength_kaleidoscopic_reality_science_multiblock_energy_storage_gui.png");
    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthJenithVoidScienceMultiblockEnergyStorageScreen(BasicStrengthJenithVoidScienceMultiblockEnergyStorageMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
