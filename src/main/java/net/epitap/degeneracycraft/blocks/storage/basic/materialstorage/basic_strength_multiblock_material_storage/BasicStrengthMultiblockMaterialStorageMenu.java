...
public class BasicStrengthMultiblockMaterialStorageMenu extends AbstractContainerMenu {
    ...
    public BasicStrengthMultiblockMaterialStorageMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        blockEntity = (BasicStrengthMultiblockMaterialStorageBlockEntity) entity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.BASIC_STRENGTH_MULTIBLOCK_MATERIAL_STORAGE_BLOCK.get());
    }
