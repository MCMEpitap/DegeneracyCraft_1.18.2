...
//        add(DCBlocks.END_CASSITERITE_ORE.get(), "End Cassiterite Ore");
        ...
        add(DCItems.BAUXITE_HYPERFLUID.get(),"Bauxite Hyper Fluid");
        ...
        add(DCItems.BERYL_HYPERFLUID.get(),"Beryl Hyper Fluid");
        ...
        add(DCItems.BORAX_HYPERFLUID.get(),"Borax Hyper Fluid");
        ...
        add(DCItems.CASSITERITE_HYPERFLUID.get(),"Cassiterite Hyper Fluid");
        ...
        add(DCItems.CHROMITE_HYPERFLUID.get(),"Chromite Hyper Fluid");
        ...
        add(DCItems.FLUORITE_HYPERFLUID.get(),"Fluorite Hyper Fluid");
        ...
        add(DCItems.GRAPHITE_HYPERFLUID.get(),"Graphite Hyper Fluid");
        ...
        add(DCItems.IRON_HYPERFLUID.get(),"Iron Hyper Fluid");
        ...
        add(DCItems.LATERITE_HYPERFLUID.get(),"Laterite Hyper Fluid");
        ...
        add(DCItems.LIMESTONE_HYPERFLUID.get(),"Limestone Hyper Fluid");
        ...
        add(DCItems.PHOSPHORITE_HYPERFLUID.get(),"Phosphorite Hyper Fluid");
        ...
        add(DCItems.PEGMATITE_HYPERFLUID.get(),"Pegmatite Hyper Fluid");
        ...
        add(DCItems.PYROLUSITE_HYPERFLUID.get(),"Pyrolusite Hyper Fluid");
        ...
        add(DCItems.RUTILE_HYPERFLUID.get(),"Rutile Hyper Fluid");
        ...
        add(DCItems.SPODUMENE_HYPERFLUID.get(),"Spodumene Hyper Fluid");
        ...
        add(DCItems.ULEXITE_HYPERFLUID.get(),"Ulexite Hyper Fluid");
        ...
        add(DCItems.VANADINITE_HYPERFLUID.get(),"Vanadinite Hyper Fluid");
        ...
        add(DCItems.SYLVITE_HYPERFLUID.get(),"Sylvite Hyper Fluid");
...
//        add(DCItems.HYPER_CLASS_IRON_BEARING.get(),"Hyper Class Iron Bearing");
//        add(DCItems.HYPER_CLASS_IRON_BOLT.get(),"Hyper Class Iron Bolt");
//        add(DCItems.HYPER_CLASS_IRON_CAM.get(),"Hyper Class Iron Cam");
//        add(DCItems.HYPER_CLASS_IRON_CHAIN.get(),"Hyper Class Iron Chain");
//        add(DCItems.HYPER_CLASS_IRON_GEAR.get(),"Hyper Class Iron Gear");
//        add(DCItems.HYPER_CLASS_IRON_JOINT.get(),"Hyper Class Iron Joint");
//        add(DCItems.HYPER_CLASS_IRON_KEY.get(),"Hyper Class Iron Key");
//        add(DCItems.HYPER_CLASS_IRON_NUT.get(),"Hyper Class Iron Nut");
//        add(DCItems.HYPER_CLASS_IRON_PIPE.get(),"Hyper Class Iron Pipe");
//        add(DCItems.HYPER_CLASS_IRON_PIPEJOINT.get(),"Hyper Class Iron PipeJoint");
//        add(DCItems.HYPER_CLASS_IRON_PLATE.get(),"Hyper Class Iron Plate");
//        add(DCItems.HYPER_CLASS_IRON_ROD.get(),"Hyper Class Iron Rod");
//        add(DCItems.HYPER_CLASS_IRON_SHAFT.get(),"Hyper Class Iron Shaft");
//        add(DCItems.HYPER_CLASS_IRON_SHAFTCOUPLING.get(),"Hyper Class Iron ShaftCoupling");
//        add(DCItems.HYPER_CLASS_IRON_SHAPESTEEL.get(),"Hyper Class Iron ShapeSteel");
//        add(DCItems.HYPER_CLASS_IRON_SPRING.get(),"Hyper Class Iron Spring");
//
...
//        add(DCBlocks.LOW_STERNGTH_MULTIBLOCK_MACHINE_FRAME_BLOCK.get(),"Low Strength Multiblock Machine Frame Block");
        ...
        add("advancements." + "degeneracycraft" + ".astronomy" + ".description", "Going Beyond Starry Sky");
        ...
        add("degeneracycraft_introduction" + ".landing",
                "This DegeneracyCraft is a mod for industrial romance! <br>It consists of 7 main areas and 10 phases!<br>This DCraftPedia is the instruction manual for DegeneracyCraft!");
    }
