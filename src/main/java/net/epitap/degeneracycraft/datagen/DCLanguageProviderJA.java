...
//        add(DCBlocks.END_CASSITERITE_ORE.get(), "エンド錫石");
        ...
        add(DCItems.BAUXITE_HYPERFLUID.get(),"鉄ばん土鉱の過流動体");
        ...
        add(DCItems.BERYL_HYPERFLUID.get(),"緑柱石の過流動体");
        ...
        add(DCItems.BORAX_HYPERFLUID.get(),"ホウ砂の過流動体");
        ...
        add(DCItems.CASSITERITE_HYPERFLUID.get(),"錫石の過流動体");
        ...
        add(DCItems.CHROMITE_HYPERFLUID.get(),"クロム鉄鉱の過流動体");
        ...
        add(DCItems.FLUORITE_HYPERFLUID.get(),"蛍石の過流動体");
        ...
        add(DCItems.GRAPHITE_HYPERFLUID.get(),"黒鉛の過流動体");
        ...
        add(DCItems.IRON_HYPERFLUID.get(),"鉄の過流動体");
        ...
        add(DCItems.LATERITE_HYPERFLUID.get(),"紅土鉱の過流動体");
        ...
        add(DCItems.LIMESTONE_HYPERFLUID.get(),"石灰石の過流動体");
        ...
        add(DCItems.PHOSPHORITE_HYPERFLUID.get(),"リン鉱石の過流動体");
        ...
        //
        add(DCItems.RAW_PEGMATITE_ORE.get(), "鬼御影の原石");
        add(DCItems.PEGMATITE_DUST.get(),"鬼御影の粉");
        add(DCItems.PEGMATITE_PUREDUST.get(),"鬼御影の純粋な粉");
        add(DCItems.PEGMATITE_LEACHATE.get(),"鬼御影の浸出液");
        add(DCItems.PEGMATITE_CONCENTRATE.get(),"鬼御影の濃縮液");
        add(DCItems.PEGMATITE_PLASMA.get(),"鬼御影のプラズマ");
        add(DCItems.PEGMATITE_DEGENERATEMATTER.get(),"鬼御影の縮退物質");
        add(DCItems.PEGMATITE_SOUP.get(),"鬼御影のスープ");
        add(DCItems.PEGMATITE_IMAGINARYMATTER.get(),"鬼御影の虚数物質");
        add(DCItems.STABLE_PEGMATITE_IMAGINARYMATTER.get(),"安定した鬼御影の虚数物質");
        add(DCItems.PEGMATITE_TACHYON.get(),"鬼御影のタキオン");
        add(DCItems.PEGMATITE_ANTIMATTER.get(),"鬼御影の反物質");
        add(DCItems.PEGMATITE_ULTRAHOTPLASMA.get(),"鬼御影の超高温プラズマ");
        add(DCItems.PEGMATITE_HYPERFLUID.get(),"鬼御影の過流動体");
        add(DCItems.PEGMATITE_CRYSTAL.get(),"鬼御影の結晶塊");
        add(DCItems.PEGMATITE_PRECIPITATE.get(),"鬼御影の沈殿物");
        add(DCItems.PEGMATITE_WASHEDDUST.get(),"鬼御影の洗浄された粉");
        add(DCItems.PEGMATITE_ORESINTER.get(),"鬼御影の焼結鉱");
        add(DCItems.PEGMATITE_INGOT.get(), "鬼御影インゴット");
        //
        ...
        add(DCItems.PYROLUSITE_HYPERFLUID.get(),"軟マンガン鉱の過流動体");
        ...
        add(DCItems.RUTILE_HYPERFLUID.get(),"金紅石の過流動体");
        ...
        add(DCItems.SPODUMENE_HYPERFLUID.get(),"リシア輝石の過流動体");
        ...
        add(DCItems.SYLVITE_HYPERFLUID.get(),"カリ岩塩の過流動体");
        ...
        add(DCItems.ULEXITE_HYPERFLUID.get(),"曹灰ホウ石の過流動体");
        ...
        add(DCItems.VANADINITE_HYPERFLUID.get(),"褐鉛鉱の過流動体");
        ...
        add(DCItems.COPPER_SPRING.get(),"銅のばね");
...
//        add(DCBlocks.LOW_STERNGTH_MULTIBLOCK_MACHINE_FRAME_BLOCK.get(),"低強度機械用フレーム");
        ...
        add("jei." + "degeneracycraft_basic_machine_part_processor", "基本精度機械要素加工機 レシピ");
        ...
        add("tooltip." + "degeneracycraft." + "ipp." + "hyper", "工業進展段階:Phase6");
