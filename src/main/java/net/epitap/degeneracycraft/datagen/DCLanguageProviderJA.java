...
//
        ...
        add(DCBlocks.BASIC_POWER_THERMAL_GENERATOR_PORT_HOLO_BLOCK.get(), "基本出力火力発電機ポート (ホログラム)");
...
//        add(DCBlocks.LOW_STERNGTH_MULTIBLOCK_MACHINE_FRAME_BLOCK.get(),"低強度機械用フレーム");
        ...
        add("jei." + "degeneracycraft_basic_technology_circuit_builder", "基本精度回路構築機 レシピ");
