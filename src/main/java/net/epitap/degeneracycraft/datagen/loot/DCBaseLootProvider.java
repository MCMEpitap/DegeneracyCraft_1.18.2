...
public abstract class DCBaseLootProvider extends LootTableProvider {
    ...
    public DCBaseLootProvider(DataGenerator dataGeneratorIn) {
    ...
    public String getName() {
        return "DegeneracyCraft LootTables";
    }
}
