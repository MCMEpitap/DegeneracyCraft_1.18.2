...
public class BasicPerformanceFineParticleAdsorberRecipeCategory implements IRecipeCategory<BasicPerformanceFineParticleAdsorberRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "basic_performance_fine_particle_adsorber_recipe");
    ...
    public BasicPerformanceFineParticleAdsorberRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 154);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM, new ItemStack(DCBlocks.BASIC_PERFORMANCE_FINE_PARTICLE_ADSORBER_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicPerformanceFineParticleAdsorberRecipe> getRecipeClass() {
        return BasicPerformanceFineParticleAdsorberRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_performance_fine_particle_adsorber");
    }
    ...
    public static final RecipeType<BasicPerformanceFineParticleAdsorberRecipe> TYPE =
            new RecipeType<>(UID, BasicPerformanceFineParticleAdsorberRecipe.class);

    @Override
    public void draw(BasicPerformanceFineParticleAdsorberRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicPerformanceFineParticleAdsorberRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceFineParticleAdsorberRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicPerformanceFineParticleAdsorberRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull BasicPerformanceFineParticleAdsorberRecipe recipe, @Nonnull IFocusGroup focusGroup) {
