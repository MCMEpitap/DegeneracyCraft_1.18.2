...
public class BasicPerformanceAstronomicalTelescopeRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Type implements RecipeType<BasicPerformanceAstronomicalTelescopeRecipe> {
        private Type() {
        }

        public static final Type INSTANCE = new Type();
        public static final String ID = "basic_performance_astronomical_telescope_recipe";
    }


    public static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<BasicPerformanceAstronomicalTelescopeRecipe> {
        public static final Serializer INSTANCE = new Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "basic_performance_astronomical_telescope_recipe");

        public BasicPerformanceAstronomicalTelescopeRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
