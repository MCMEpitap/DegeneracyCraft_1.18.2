...
public class BasicPerformanceCellIncubatorRecipeCategory implements IRecipeCategory<BasicPerformanceCellIncubatorRecipe> {
    ...
    public BasicPerformanceCellIncubatorRecipeCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM, new ItemStack(DCBlocks.BASIC_PERFORMANCE_CELL_INCUBATOR_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicPerformanceCellIncubatorRecipe> getRecipeClass() {
        return BasicPerformanceCellIncubatorRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_performance_cell_incubator");
    }
    ...
    @Override
    public void draw(BasicPerformanceCellIncubatorRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicPerformanceCellIncubatorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceCellIncubatorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
...
//        fontRenderer.draw(poseStack, (recipe.getRequiredEnergy() / recipe.getRequiredTime() / 20F + " FE/t"), 17, 117, 0xFFFFFF);
    ...
    protected void drawRequiredTime(BasicPerformanceCellIncubatorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
