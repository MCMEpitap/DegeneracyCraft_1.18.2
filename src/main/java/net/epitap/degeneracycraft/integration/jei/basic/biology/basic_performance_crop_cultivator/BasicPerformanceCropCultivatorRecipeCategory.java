...
public class BasicPerformanceCropCultivatorRecipeCategory implements IRecipeCategory<BasicPerformanceCropCultivatorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "basic_performance_crop_cultivator_recipe");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/biology/basic_performance_crop_cultivator/basic_performance_crop_cultivator_uid.png");
    private final IDrawable background;
    private final IDrawable icon;

    public BasicPerformanceCropCultivatorRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 154);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(DCBlocks.BASIC_PERFORMANCE_CROP_CULTIVATOR_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicPerformanceCropCultivatorRecipe> getRecipeClass() {
        return BasicPerformanceCropCultivatorRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_performance_crop_cultivator");
    }
    ...
    public static final RecipeType<BasicPerformanceCropCultivatorRecipe> TYPE =
            new RecipeType<>(UID, BasicPerformanceCropCultivatorRecipe.class);

    @Override
    public void draw(BasicPerformanceCropCultivatorRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicPerformanceCropCultivatorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceCropCultivatorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
...
//        fontRenderer.draw(poseStack, (recipe.getRequiredEnergy() / recipe.getRequiredTime() / 20F + " FE/t"), 17, 117, 0xFFFFFF);
    ...
    protected void drawRequiredTime(BasicPerformanceCropCultivatorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull BasicPerformanceCropCultivatorRecipe recipe, @Nonnull IFocusGroup focusGroup) {
