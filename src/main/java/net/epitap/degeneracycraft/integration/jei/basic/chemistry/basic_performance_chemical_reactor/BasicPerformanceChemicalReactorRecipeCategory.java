...
public class BasicPerformanceChemicalReactorRecipeCategory implements IRecipeCategory<BasicPerformanceChemicalReactorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "basic_performance_chemical_reactor_recipe");
    ...
    public BasicPerformanceChemicalReactorRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 154);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM, new ItemStack(DCBlocks.BASIC_PERFORMANCE_CHEMICAL_REACTOR_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicPerformanceChemicalReactorRecipe> getRecipeClass() {
        return BasicPerformanceChemicalReactorRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_performance_chemical_reactor");
    }
    ...
    public static final RecipeType<BasicPerformanceChemicalReactorRecipe> TYPE =
            new RecipeType<>(UID, BasicPerformanceChemicalReactorRecipe.class);

    @Override
    public void draw(BasicPerformanceChemicalReactorRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceChemicalReactorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicPerformanceChemicalReactorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull BasicPerformanceChemicalReactorRecipe recipe, @Nonnull IFocusGroup focusGroup) {
