...
public class BasicPerformanceCompoundPurifierRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Type implements RecipeType<BasicPerformanceCompoundPurifierRecipe> {
        private Type() {
        }

        public static final Type INSTANCE = new Type();
        public static final String ID = "basic_performance_compound_purifier_recipe";
    }


    public static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<BasicPerformanceCompoundPurifierRecipe> {
        public static final Serializer INSTANCE = new Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "basic_performance_compound_purifier_recipe");

        public BasicPerformanceCompoundPurifierRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {

            float energy = GsonHelper.getAsFloat(pJson, "energy", 1);
            float time = GsonHelper.getAsFloat(pJson, "time", 1);
            ItemStack input0 = BasicPerformanceCompoundPurifierRecipe.itemStackFromJson(GsonHelper.getAsJsonObject(pJson, "input0"));
        ...
        @Override
        public @Nullable BasicPerformanceCompoundPurifierRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, BasicPerformanceCompoundPurifierRecipe pRecipe) {
