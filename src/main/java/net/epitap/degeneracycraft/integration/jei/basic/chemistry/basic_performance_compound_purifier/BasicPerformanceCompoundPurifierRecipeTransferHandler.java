...
public class BasicPerformanceCompoundPurifierRecipeTransferHandler<T extends BasicPerformanceCompoundPurifierMenu, R extends BasicPerformanceCompoundPurifierRecipe>
        implements IRecipeTransferHandler<T, BasicPerformanceCompoundPurifierRecipe> {
    ...
    public BasicPerformanceCompoundPurifierRecipeTransferHandler(Class<T> containerClass,
    ...
    @Override
    public Class<BasicPerformanceCompoundPurifierRecipe> getRecipeClass() {
    ...
    public @Nullable IRecipeTransferError transferRecipe(
            ...
            BasicPerformanceCompoundPurifierRecipe recipe,
