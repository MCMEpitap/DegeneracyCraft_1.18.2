...
public class BasicPerformanceElectrolyserRecipeCategory implements IRecipeCategory<BasicPerformanceElectrolyserRecipe> {
    ...
    public BasicPerformanceElectrolyserRecipeCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(DCBlocks.BASIC_PERFORMANCE_ELECTROLYSER_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicPerformanceElectrolyserRecipe> getRecipeClass() {
        return BasicPerformanceElectrolyserRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_performance_electrolyser");
    }
    ...
    protected void drawRequiredEnergy(BasicPerformanceElectrolyserRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceElectrolyserRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicPerformanceElectrolyserRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
