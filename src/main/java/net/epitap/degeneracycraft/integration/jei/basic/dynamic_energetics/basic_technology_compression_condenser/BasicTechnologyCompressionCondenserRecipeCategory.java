...
public class BasicTechnologyCompressionCondenserRecipeCategory implements IRecipeCategory<BasicTechnologyCompressionCondenserRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "basic_technology_compression_condenser_recipe");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/dynamic_energetics/basic_technology_compression_condenser/basic_technology_compression_condenser_uid.png");
    private final IDrawable background;
    private final IDrawable icon;

    public BasicTechnologyCompressionCondenserRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 151);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(DCBlocks.BASIC_TECHNOLOGY_COMPRESSION_CONDENSER_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicTechnologyCompressionCondenserRecipe> getRecipeClass() {
        return BasicTechnologyCompressionCondenserRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_technology_compression_condenser");
    }
    ...
    public static final RecipeType<BasicTechnologyCompressionCondenserRecipe> TYPE =
            new RecipeType<>(UID, BasicTechnologyCompressionCondenserRecipe.class);


    @Override
    public void draw(BasicTechnologyCompressionCondenserRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicTechnologyCompressionCondenserRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicTechnologyCompressionCondenserRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicTechnologyCompressionCondenserRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, BasicTechnologyCompressionCondenserRecipe recipe, IFocusGroup focusGroup) {
