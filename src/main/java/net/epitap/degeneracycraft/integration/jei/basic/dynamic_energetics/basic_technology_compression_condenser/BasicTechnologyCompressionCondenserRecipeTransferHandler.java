...
public class BasicTechnologyCompressionCondenserRecipeTransferHandler<T extends BasicTechnologyCompressionCondenserMenu, R extends BasicTechnologyCompressionCondenserRecipe>
        implements IRecipeTransferHandler<T, BasicTechnologyCompressionCondenserRecipe> {
    ...
    public BasicTechnologyCompressionCondenserRecipeTransferHandler(Class<T> containerClass,
    ...
    @Override
    public Class<BasicTechnologyCompressionCondenserRecipe> getRecipeClass() {
