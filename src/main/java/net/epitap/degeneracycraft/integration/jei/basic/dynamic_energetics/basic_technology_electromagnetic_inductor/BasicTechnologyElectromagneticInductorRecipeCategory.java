...
public class BasicTechnologyElectromagneticInductorRecipeCategory implements IRecipeCategory<BasicTechnologyElectromagneticInductorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "basic_technology_electromagnetic_inductor_recipe");
    ...
    public BasicTechnologyElectromagneticInductorRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 151);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM, new ItemStack(DCBlocks.BASIC_TECHNOLOGY_ELECTROMAGNETIC_INDUCTOR_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicTechnologyElectromagneticInductorRecipe> getRecipeClass() {
        return BasicTechnologyElectromagneticInductorRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_technology_electromagnetic_inductor");
    }
    ...
    public static final RecipeType<BasicTechnologyElectromagneticInductorRecipe> TYPE =
            new RecipeType<>(UID, BasicTechnologyElectromagneticInductorRecipe.class);


    @Override
    public void draw(BasicTechnologyElectromagneticInductorRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicTechnologyElectromagneticInductorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicTechnologyElectromagneticInductorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicTechnologyElectromagneticInductorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, BasicTechnologyElectromagneticInductorRecipe recipe, IFocusGroup focusGroup) {
        ...
        builder.addSlot(RecipeIngredientRole.INPUT, 8, 43).addItemStack(recipe.getInput4Item());
        builder.addSlot(RecipeIngredientRole.INPUT, 44, 43).addItemStack(recipe.getInput5Item());
