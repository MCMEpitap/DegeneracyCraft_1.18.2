...
public class BasicTechnologyMultiblockEquipmentFabricatorRecipeCategory implements IRecipeCategory<BasicTechnologyMultiblockEquipmentFabricatorRecipe> {
    ...
    public BasicTechnologyMultiblockEquipmentFabricatorRecipeCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(DCBlocks.BASIC_TECHNOLOGY_MULTIBLOCK_EQUIPMENT_FABRICATOR_BLOCK.get()));
    }
    ...
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_technology_multiblock_equipment_fabricator");
    }
    ...
    public static final RecipeType<BasicTechnologyMultiblockEquipmentFabricatorRecipe> TYPE =
            new RecipeType<>(UID, BasicTechnologyMultiblockEquipmentFabricatorRecipe.class);
