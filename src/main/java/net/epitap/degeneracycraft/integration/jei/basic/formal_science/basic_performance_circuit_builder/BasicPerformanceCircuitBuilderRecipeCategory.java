...
public class BasicPerformanceCircuitBuilderRecipeCategory implements IRecipeCategory<BasicPerformanceCircuitBuilderRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "basic_performance_circuit_builder_recipe");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/formal_science/basic_performance_circuit_builder/basic_performance_circuit_builder_uid.png");
    private final IDrawable background;
    private final IDrawable icon;

    public BasicPerformanceCircuitBuilderRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 154);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(DCBlocks.BASIC_PERFORMANCE_CIRCUIT_BUILDER_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicPerformanceCircuitBuilderRecipe> getRecipeClass() {
        return BasicPerformanceCircuitBuilderRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_performance_circuit_builder");
    }
    ...
    public static final RecipeType<BasicPerformanceCircuitBuilderRecipe> TYPE =
            new RecipeType<>(UID, BasicPerformanceCircuitBuilderRecipe.class);

    @Override
    public void draw(BasicPerformanceCircuitBuilderRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicPerformanceCircuitBuilderRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceCircuitBuilderRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicPerformanceCircuitBuilderRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
