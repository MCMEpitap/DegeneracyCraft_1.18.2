...
public class BasicPerformanceDesignatedDataInjectorRecipeCategory implements IRecipeCategory<BasicPerformanceDesignatedDataInjectorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "basic_performance_designated_data_injector_recipe");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/formal_science/basic_performance_designated_data_injector/basic_performance_designated_data_injector_uid.png");
    private final IDrawable background;
    private final IDrawable icon;

    public BasicPerformanceDesignatedDataInjectorRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 154);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(DCBlocks.BASIC_PERFORMANCE_DESIGNATED_DATA_INJECTOR_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicPerformanceDesignatedDataInjectorRecipe> getRecipeClass() {
        return BasicPerformanceDesignatedDataInjectorRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_performance_designated_data_injector");
    }
    ...
    protected void drawRequiredEnergy(BasicPerformanceDesignatedDataInjectorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceDesignatedDataInjectorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicPerformanceDesignatedDataInjectorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull BasicPerformanceDesignatedDataInjectorRecipe recipe, @Nonnull IFocusGroup focusGroup) {
