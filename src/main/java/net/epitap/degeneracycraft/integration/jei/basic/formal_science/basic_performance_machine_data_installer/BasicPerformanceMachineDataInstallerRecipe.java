...
public class BasicPerformanceMachineDataInstallerRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Type implements RecipeType<BasicPerformanceMachineDataInstallerRecipe> {
        private Type() {
        }

        public static final Type INSTANCE = new Type();
        public static final String ID = "basic_performance_machine_data_installer_recipe";
    }


    public static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<BasicPerformanceMachineDataInstallerRecipe> {
        public static final Serializer INSTANCE = new Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "basic_performance_machine_data_installer_recipe");

        public BasicPerformanceMachineDataInstallerRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
        ...
        @Override
        public @Nullable BasicPerformanceMachineDataInstallerRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, BasicPerformanceMachineDataInstallerRecipe pRecipe) {
