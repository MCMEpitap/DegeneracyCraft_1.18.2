...
public class BasicPerformanceMachineDataInstallerRecipeCategory implements IRecipeCategory<BasicPerformanceMachineDataInstallerRecipe> {
    ...
    public BasicPerformanceMachineDataInstallerRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 154);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(DCBlocks.BASIC_PERFORMANCE_MACHINE_DATA_INSTALLER_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicPerformanceMachineDataInstallerRecipe> getRecipeClass() {
        return BasicPerformanceMachineDataInstallerRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_performance_machine_data_installer");
    }
    ...
    public static final RecipeType<BasicPerformanceMachineDataInstallerRecipe> TYPE =
            new RecipeType<>(UID, BasicPerformanceMachineDataInstallerRecipe.class);


    @Override
    public void draw(BasicPerformanceMachineDataInstallerRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicPerformanceMachineDataInstallerRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceMachineDataInstallerRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicPerformanceMachineDataInstallerRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
