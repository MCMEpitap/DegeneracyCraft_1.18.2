...
public class BasicPerformanceOreSorterRecipeCategory implements IRecipeCategory<BasicPerformanceOreSorterRecipe> {
    ...
    public BasicPerformanceOreSorterRecipeCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM, new ItemStack(DCBlocks.BASIC_PERFORMANCE_ORE_SORTER_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicPerformanceOreSorterRecipe> getRecipeClass() {
        return BasicPerformanceOreSorterRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_performance_ore_sorter");
    }
    ...
    @Override
    public void draw(BasicPerformanceOreSorterRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicPerformanceOreSorterRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceOreSorterRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicPerformanceOreSorterRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
