...
public class BasicPerformanceRockCrasherRecipe implements Recipe<SimpleContainer> {
    ...
    public BasicPerformanceRockCrasherRecipe(ResourceLocation id, float energy, float time, ItemStack input0, ItemStack output0, ItemStack output1, ItemStack output2) {
        this.id = id;
        this.energy = energy;
        this.time = time;
        this.input0 = input0;
    ...
    public static class Type implements RecipeType<BasicPerformanceRockCrasherRecipe> {
        private Type() {
        }

        public static final Type INSTANCE = new Type();
        public static final String ID = "basic_performance_rock_crasher_recipe";
    }


    public static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<BasicPerformanceRockCrasherRecipe> {
        public static final Serializer INSTANCE = new Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "basic_performance_rock_crasher_recipe");

        public BasicPerformanceRockCrasherRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
        ...
        @Override
        public @Nullable BasicPerformanceRockCrasherRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, BasicPerformanceRockCrasherRecipe pRecipe) {
