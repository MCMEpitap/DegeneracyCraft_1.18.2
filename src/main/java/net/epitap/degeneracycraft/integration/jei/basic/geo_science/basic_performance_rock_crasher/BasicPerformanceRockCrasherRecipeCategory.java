...
public class BasicPerformanceRockCrasherRecipeCategory implements IRecipeCategory<BasicPerformanceRockCrasherRecipe> {
    ...
    public BasicPerformanceRockCrasherRecipeCategory(IGuiHelper helper) {
    ...
    public static final RecipeType<BasicPerformanceRockCrasherRecipe> TYPE =
            new RecipeType<>(UID, BasicPerformanceRockCrasherRecipe.class);
