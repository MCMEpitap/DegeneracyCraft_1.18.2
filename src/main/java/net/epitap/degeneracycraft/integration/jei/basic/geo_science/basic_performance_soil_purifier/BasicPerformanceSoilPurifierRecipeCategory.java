...
public class BasicPerformanceSoilPurifierRecipeCategory implements IRecipeCategory<BasicPerformanceSoilPurifierRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "basic_performance_soil_purifier_recipe");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/geo_science/basic_performance_soil_purifier/basic_performance_soil_purifier_uid.png");
    private final IDrawable background;
    private final IDrawable icon;

    public BasicPerformanceSoilPurifierRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 154);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(DCBlocks.BASIC_PERFORMANCE_SOIL_PURIFIER_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicPerformanceSoilPurifierRecipe> getRecipeClass() {
        return BasicPerformanceSoilPurifierRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_performance_soil_purifier");
    }
    ...
    public static final RecipeType<BasicPerformanceSoilPurifierRecipe> TYPE =
            new RecipeType<>(UID, BasicPerformanceSoilPurifierRecipe.class);

    @Override
    public void draw(BasicPerformanceSoilPurifierRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicPerformanceSoilPurifierRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceSoilPurifierRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
...
//        fontRenderer.draw(poseStack, (recipe.getRequiredEnergy() / recipe.getRequiredTime() / 20F + " FE/t"), 17, 117, 0xFFFFFF);
    ...
    protected void drawRequiredTime(BasicPerformanceSoilPurifierRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull BasicPerformanceSoilPurifierRecipe recipe, @Nonnull IFocusGroup focusGroup) {
