...
public class BasicPerformanceElectricArcFurnaceRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Type implements RecipeType<BasicPerformanceElectricArcFurnaceRecipe> {
        private Type() {
        }

        public static final Type INSTANCE = new Type();
        public static final String ID = "basic_performance_electric_arc_furnace_recipe";
    }


    public static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<BasicPerformanceElectricArcFurnaceRecipe> {
        public static final Serializer INSTANCE = new Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "basic_performance_electric_arc_furnace_recipe");

        public BasicPerformanceElectricArcFurnaceRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
        ...
        @Override
        public @Nullable BasicPerformanceElectricArcFurnaceRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, BasicPerformanceElectricArcFurnaceRecipe pRecipe) {
