...
public class BasicPerformanceMaterialSeparatorRecipeCategory implements IRecipeCategory<BasicPerformanceMaterialSeparatorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "basic_performance_material_separator_recipe");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/hybrid_physics/basic_performance_material_separator/basic_performance_material_separator_uid.png");
    private final IDrawable background;
    private final IDrawable icon;

    public BasicPerformanceMaterialSeparatorRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 154);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(DCBlocks.BASIC_PERFORMANCE_MATERIAL_SEPARATOR_BLOCK.get()));
    }
    ...
    @Override
    public @NotNull Class<? extends BasicPerformanceMaterialSeparatorRecipe> getRecipeClass() {
        return BasicPerformanceMaterialSeparatorRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_performance_material_separator");
    }
    ...
    public static final RecipeType<BasicPerformanceMaterialSeparatorRecipe> TYPE =
            new RecipeType<>(UID, BasicPerformanceMaterialSeparatorRecipe.class);

    @Override
    public void draw(BasicPerformanceMaterialSeparatorRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceMaterialSeparatorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicPerformanceMaterialSeparatorRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull BasicPerformanceMaterialSeparatorRecipe recipe, @Nonnull IFocusGroup focusGroup) {
