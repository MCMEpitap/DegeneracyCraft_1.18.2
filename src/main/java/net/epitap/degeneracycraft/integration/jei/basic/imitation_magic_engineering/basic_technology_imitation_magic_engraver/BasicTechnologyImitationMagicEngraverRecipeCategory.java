...
public class BasicTechnologyImitationMagicEngraverRecipeCategory implements IRecipeCategory<BasicTechnologyImitationMagicEngraverRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "basic_technology_imitation_magic_engraver_recipe");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/imitation_magic_engineering/basic_technology_imitation_magic_engraver/basic_technology_imitation_magic_engraver_uid.png");
    private final IDrawable background;
    private final IDrawable icon;

    public BasicTechnologyImitationMagicEngraverRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 151);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(DCBlocks.BASIC_TECHNOLOGY_IMITATION_MAGIC_ENGRAVER_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicTechnologyImitationMagicEngraverRecipe> getRecipeClass() {
        return BasicTechnologyImitationMagicEngraverRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_technology_imitation_magic_engraver");
    }
    ...
    public static final RecipeType<BasicTechnologyImitationMagicEngraverRecipe> TYPE =
            new RecipeType<>(UID, BasicTechnologyImitationMagicEngraverRecipe.class);


    @Override
    public void draw(BasicTechnologyImitationMagicEngraverRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicTechnologyImitationMagicEngraverRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicTechnologyImitationMagicEngraverRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicTechnologyImitationMagicEngraverRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, BasicTechnologyImitationMagicEngraverRecipe recipe, IFocusGroup focusGroup) {
