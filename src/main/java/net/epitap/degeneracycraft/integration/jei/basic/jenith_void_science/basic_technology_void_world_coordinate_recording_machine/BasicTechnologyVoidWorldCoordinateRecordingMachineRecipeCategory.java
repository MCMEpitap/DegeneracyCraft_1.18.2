...
public class BasicTechnologyVoidWorldCoordinateRecordingMachineRecipeCategory implements IRecipeCategory<BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "basic_technology_void_world_coordinate_recording_machine_recipe");
    ...
    public BasicTechnologyVoidWorldCoordinateRecordingMachineRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 151);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM, new ItemStack(DCBlocks.BASIC_TECHNOLOGY_VOID_WORLD_COORDINATE_RECORDING_MACHINE_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe> getRecipeClass() {
        return BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_technology_void_world_coordinate_recording_machine");
    }
    ...
    public static final RecipeType<BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe> TYPE =
            new RecipeType<>(UID, BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe.class);


    @Override
    public void draw(BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe recipe, IFocusGroup focusGroup) {
