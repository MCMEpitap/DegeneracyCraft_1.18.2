...
public class BasicPerformanceRealityPhaseAdjustmentMachineRecipeCategory implements IRecipeCategory<BasicPerformanceRealityPhaseAdjustmentMachineRecipe> {
    ...
    public BasicPerformanceRealityPhaseAdjustmentMachineRecipeCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM, new ItemStack(DCBlocks.BASIC_PERFORMANCE_REALITY_PHASE_ADJUSTMENT_MACHINE_BLOCK.get()));
    }
    ...
    @Override
    public Class<? extends BasicPerformanceRealityPhaseAdjustmentMachineRecipe> getRecipeClass() {
        return BasicPerformanceRealityPhaseAdjustmentMachineRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TranslatableComponent("jei.degeneracycraft_basic_performance_reality_phase_adjustment_machine");
    }
    ...
    @Override
    public void draw(BasicPerformanceRealityPhaseAdjustmentMachineRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicPerformanceRealityPhaseAdjustmentMachineRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceRealityPhaseAdjustmentMachineRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicPerformanceRealityPhaseAdjustmentMachineRecipe recipe, PoseStack poseStack) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
