...
public class RedstonePoweredMachinePartManufactureMachineRecipeCategory implements IRecipeCategory<RedstonePoweredMachinePartManufactureMachineRecipe> {
    ...
    public RedstonePoweredMachinePartManufactureMachineRecipeCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(DCBlocks.REDSTONE_POWERED_MACHINE_PART_MANUFACTURE_MACHINE_BLOCK.get()));
    }
    ...
    public static final RecipeType<RedstonePoweredMachinePartManufactureMachineRecipe> TYPE =
            new RecipeType<>(UID, RedstonePoweredMachinePartManufactureMachineRecipe.class);
