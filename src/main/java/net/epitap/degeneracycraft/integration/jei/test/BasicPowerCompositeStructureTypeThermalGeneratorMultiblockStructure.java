...
public class BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure implements Recipe<SimpleContainer> {
    ...
    public BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure(ResourceLocation id, float energy, float time, ItemStack input0, ItemStack input1, ItemStack input2, ItemStack input3, ItemStack input4, ItemStack input5, ItemStack input6, ItemStack input7, ItemStack input8, ItemStack output0) {
        this.id = id;
        this.energy = energy;
        this.time = time;
        this.input0 = input0;
    ...
    public RecipeType<?> getType() {
        return BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure.Type.INSTANCE;
    }

    public static class Type implements RecipeType<BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure> {
        private Type() {
        }
    ...
    public static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure> {
        public Serializer() {
        }
        ...
        public BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            ItemStack input0 = BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure.itemStackFromJson(GsonHelper.getAsJsonObject(pJson, "input0"));
            ItemStack input1 = BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure.itemStackFromJson(GsonHelper.getAsJsonObject(pJson, "input1"));
            ItemStack input2 = BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure.itemStackFromJson(GsonHelper.getAsJsonObject(pJson, "input2"));
            ItemStack input3 = BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure.itemStackFromJson(GsonHelper.getAsJsonObject(pJson, "input3"));
            ItemStack input4 = BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure.itemStackFromJson(GsonHelper.getAsJsonObject(pJson, "input4"));
            ItemStack input5 = BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure.itemStackFromJson(GsonHelper.getAsJsonObject(pJson, "input5"));
            ItemStack input6 = BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure.itemStackFromJson(GsonHelper.getAsJsonObject(pJson, "input6"));
            ItemStack input7 = BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure.itemStackFromJson(GsonHelper.getAsJsonObject(pJson, "input7"));
            ItemStack input8 = BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure.itemStackFromJson(GsonHelper.getAsJsonObject(pJson, "input8"));
            ItemStack output0 = BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure.itemStackFromJson(GsonHelper.getAsJsonObject(pJson, "output0"));

            return new BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure(pRecipeId, energy, time, input0, input1, input2, input3, input4, input5, input6, input7, input8, output0);

        }

        @Override
        public @Nullable BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, BasicPowerCompositeStructureTypeThermalGeneratorMultiblockStructure pRecipe) {
