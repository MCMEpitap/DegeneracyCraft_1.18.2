...
import net.epitap.degeneracycraft.pipe.basic.BasicItemPipeEntity;
import net.epitap.degeneracycraft.pipe.basic.BasicItemPipeRenderer;
import net.epitap.degeneracycraft.pipe.energy.BasicEnergyPipeBlockEntity;
import net.epitap.degeneracycraft.pipe.energy.BasicEnergyPipeRenderer;
import net.epitap.degeneracycraft.pipe.block.PipeBlocks;
import net.epitap.degeneracycraft.pipe.energy.floa.FloatEnergyPipeBlockEntity;
import net.epitap.degeneracycraft.pipe.energy.floa.FloatEnergyPipeRenderer;
