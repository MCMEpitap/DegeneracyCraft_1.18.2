...
public class BasicPerformanceElectricArcFurnaceBusEnergyStorage implements IEnergyStorage {
    protected PortWorkBlockEntity pipe;
    protected Direction side;
    protected float lastReceived;

    public BasicPerformanceElectricArcFurnaceBusEnergyStorage(PortWorkBlockEntity pipe, Direction side) {
        this.pipe = pipe;
        this.side = side;
    }
    ...
    public int receiveEnergy(int maxReceive, boolean simulate) {
        this.lastReceived = this.pipe.getLevel().getGameTime();
        return (int) BasicPerformanceElectricArcFurnaceBusType.INSTANCE.receiveEnergy(this.pipe, this.side, maxReceive, simulate);
    }
