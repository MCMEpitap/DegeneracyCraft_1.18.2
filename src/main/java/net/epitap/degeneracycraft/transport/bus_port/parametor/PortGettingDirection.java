...
public class PortGettingDirection implements INBTSerializable<CompoundTag> {

    private BlockPos pos;
    private Direction direction;

    public PortGettingDirection(BlockPos pos, Direction direction) {
        this.pos = pos;
    ...
    public boolean equals(Object o) {
        ...
        PortGettingDirection that = (PortGettingDirection) o;
