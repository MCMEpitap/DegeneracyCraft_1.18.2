...
public class PipeGettingDirection implements INBTSerializable<CompoundTag> {

    private BlockPos pos;
    private Direction direction;

    public PipeGettingDirection(BlockPos pos, Direction direction) {
        this.pos = pos;
    ...
    public boolean equals(Object o) {
        ...
        PipeGettingDirection that = (PipeGettingDirection) o;
