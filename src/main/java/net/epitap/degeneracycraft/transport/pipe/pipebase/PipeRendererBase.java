...
public abstract class PipeRendererBase implements BlockEntityRenderer<PipeBlockEntityBase> {
    ...
    @Override
    public void render(PipeBlockEntityBase pipe, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
    ...
    public abstract DCPipeModel getModel();
