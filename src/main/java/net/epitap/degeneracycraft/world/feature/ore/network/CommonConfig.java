...
//        CompatConfig.init(COMMON_BUILDER);
    ...
    private static void init() {
        ...
        DEBUG_WORLD_GEN = COMMON_BUILDER.comment("Output info into the logs when generating veins")
                .define("debugWorldgen", false);
        ADVANCED_DEBUG_WORLD_GEN = COMMON_BUILDER.comment("Outputs really advanced info when generating veins.")
        ...
        NUMBER_PLUTONS_PER_CHUNK = COMMON_BUILDER
                .comment("The number of times will attempt to place plutons in a given chunk")
        ...
        PRO_PICK_DETECTION_BLACKLIST = COMMON_BUILDER
                .comment("A list of blocks to always ignore when prospecting, even if they're in a vein.")
