...
public class OreStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public OreStructure() {
        ...
        super(CODEC, OreStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!OreStructure.isFeatureChunk(context)) {
        ...
        if (structurePiecesGenerator.isPresent()) {
            ...
            Degeneracycraft.LOGGER.log(Level.DEBUG, "Rundown House at {}", blockpos);
        }
